...
public class ProceduraAggiudicazioneDTO implements java.io.Serializable {
	 ...
	 * @generated
	 */
	private it.csi.pbandi.pbwebrce.pbandisrv.dto.contoeconomico.StepAggiudicazione[] iter = null;

	/**
	 * @generated
	 */
	public void setIter(
			it.csi.pbandi.pbwebrce.pbandisrv.dto.contoeconomico.StepAggiudicazione[] val) {
		iter = val;
	}
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbwebrce.pbandisrv.dto.contoeconomico.StepAggiudicazione[] getIter() {
		return iter;
	}
