...
////{PROTECTED REGION ID(R912015201) ENABLED START////}
/**
 * Inserire qui la documentazione della classe SoggettoDTO.
 * Consigli:
 * <ul>
...
public class SoggettoDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1276932274) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R374309378) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-724713910) ENABLED START*/
