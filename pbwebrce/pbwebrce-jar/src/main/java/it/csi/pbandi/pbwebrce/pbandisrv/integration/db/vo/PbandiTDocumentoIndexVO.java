...
public class PbandiTDocumentoIndexVO extends GenericVO {
	...
	public PbandiTDocumentoIndexVO (BigDecimal idProgetto, BigDecimal idModello, String numProtocollo, BigDecimal idSoggDelegato, BigDecimal idDocumentoIndex, 
			BigDecimal idSoggRapprLegale, Date dtVerificaFirma, BigDecimal idStatoDocumento, BigDecimal versione, Date dtAggiornamentoIndex, BigDecimal idUtenteIns,
			BigDecimal idTipoDocumentoIndex, String messageDigest, BigDecimal idTarget, String repository, String flagFirmaCartacea, String nomeFile, 
			String nomeDocumento, String uuidNodo, String noteDocumentoIndex, Date dtMarcaTemporale, BigDecimal idUtenteAgg, Date dtInserimentoIndex, BigDecimal idEntita, BigDecimal idCategAnagraficaMitt) {
