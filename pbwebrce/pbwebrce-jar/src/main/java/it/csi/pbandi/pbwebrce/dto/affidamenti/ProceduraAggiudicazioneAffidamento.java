...
public class ProceduraAggiudicazioneAffidamento implements java.io.Serializable {
	...
	public Boolean getNonPrevisto() {
		return nonPrevisto;
	}

	public void setNonPrevisto(Boolean nonPrevisto) {
		this.nonPrevisto = nonPrevisto;
	}

	public ProceduraAggiudicazioneAffidamento() {
		super();
