...
////{PROTECTED REGION ID(R-1760337816) ENABLED START////}
/**
...
public class MessaggioDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1360541062) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1430154222) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1172628281) ENABLED START*/
