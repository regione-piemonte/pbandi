...
public class AffidamentiProgettoRowMapper implements RowMapper<AffidamentoVO> {
	...
	public AffidamentoVO mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		cm.setDescStatoAffidamento(rs.getString("DESCSTATOAFFIDAMENTO"));
		cm.setCigProcAgg(rs.getString("CIGPROCAGG"));
		cm.setDescTipologiaAppalto(rs.getString("DESCTIPOLOGIAAPPALTO"));
