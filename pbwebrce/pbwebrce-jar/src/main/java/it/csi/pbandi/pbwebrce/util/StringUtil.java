...
public class StringUtil {
	...
	// Inserisce in msg i parametri al posto di marker del tipo {0}, {1}, etc 
	public static String formattaMsgConParam(String msg, String[] params) {
	...
	public static int trovaOccorrenza(String str, char ch, int N) {
		int occur = 0;  
		for (int i = 0; i < str.length(); i++) { 
			if (str.charAt(i) == ch) {
				occur += 1;
