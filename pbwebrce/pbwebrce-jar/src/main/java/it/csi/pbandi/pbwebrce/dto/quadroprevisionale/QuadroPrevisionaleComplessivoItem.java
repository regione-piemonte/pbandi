...
public class QuadroPrevisionaleComplessivoItem implements java.io.Serializable {
	...
	/// Field [isTotaleComplessivo]
	private boolean isTotaleComplessivo = false;

	public void setIsTotaleComplessivo(boolean val) {
		isTotaleComplessivo = val;
	}

	public boolean getIsTotaleComplessivo() {
		return isTotaleComplessivo;
	}
	...
	/// Field [dataUltimaSpesaAmmessa]
	private String dataUltimaSpesaAmmessa = null;

	public void setDataUltimaSpesaAmmessa(String val) {
		dataUltimaSpesaAmmessa = val;
	}

	public String getDataUltimaSpesaAmmessa() {
	 ...
	 */
	public QuadroPrevisionaleComplessivoItem() {
		super();

	}

	public String toString() {
		/*PROTECTED REGION ID(R-1464948890) ENABLED START*/
