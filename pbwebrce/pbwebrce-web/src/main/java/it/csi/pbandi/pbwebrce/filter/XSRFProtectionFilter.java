...
package it.csi.pbandi.pbwebrce.filter;
...
public class XSRFProtectionFilter implements Filter {
	 ...
	 */
	private static final String XSRF_HEADER_NAME = "X-XSRF-TOKEN-WEBRCE";

	/*
	 * nome del cookie XSRF
	 */
	private static final String XSRF_COOKIE_NAME = "XSRF-TOKEN-COOKIE-WEBRCE";

	/**
	 * nome dell'attributo di sessione che mantiene il token XSRF 
	 */
	private static final String XSRF_INTERNAL_TOKEN_NAME = "XSRF_SESSION_TOKEN-WEBRCE";
