...
public class ErrorMessages {
	...
	public static final String SERVICE_EXCEPTION= "Service it.csi.pbandi.pbwebbo.exception";
	public static final String NO_CONTENT = "nessun dato contenuto";
	public static final String NOT_FOUND = "Dato non trovato";
	
	//Back office
	public static final String COD_EB02 = "ATTENZIONE! L'IBAN <iban che si sta configurando> e' associato al bando linea <NOME_BANDO_LINEA recuperato al paragrafo 2.6.5>, un iban puo' essere associato a un solo Bando";
