...
@Component({
    selector: 'app-edit-allegati',
    templateUrl: 'dialog-edit-allegati.component.html',
    styleUrls: ['dialog-edit-allegati.component.scss']
})
export class DialogEditAllegati implements OnInit {
  ...
  public dialogRef: MatDialogRef<DialogEditAllegati>,
