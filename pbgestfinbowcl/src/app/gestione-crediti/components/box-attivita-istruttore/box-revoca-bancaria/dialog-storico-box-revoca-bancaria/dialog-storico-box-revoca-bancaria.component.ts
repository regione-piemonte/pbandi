...
@Component({
  selector: 'app-dialog-storico-box-revoca-bancaria',
  templateUrl: './dialog-storico-box-revoca-bancaria.component.html',
  styleUrls: ['./dialog-storico-box-revoca-bancaria.component.scss']
})
export class DialogStoricoBoxRevocaBancariaComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogStoricoBoxRevocaBancariaComponent>,
