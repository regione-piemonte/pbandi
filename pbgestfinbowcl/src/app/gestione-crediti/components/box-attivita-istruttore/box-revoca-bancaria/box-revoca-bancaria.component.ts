...
import { DialogModificaBoxRevocaBancariaComponent } from './dialog-modifica-box-revoca-bancaria/dialog-modifica-box-revoca-bancaria.component';
import { DialogStoricoBoxRevocaBancariaComponent } from './dialog-storico-box-revoca-bancaria/dialog-storico-box-revoca-bancaria.component';


@Component({
  selector: 'box-revoca-bancaria',
  templateUrl: './box-revoca-bancaria.component.html',
  styleUrls: ['./box-revoca-bancaria.component.scss']
})
@AutoUnsubscribe({ objectName: 'subscribers' })
export class BoxRevocaBancariaComponent implements OnInit {
  @Input() item ;
  @Input() ambito ;
  @Input() nomeBox ;
  ...
  openDialogModifica() {
    this.dialog.open(DialogModificaBoxRevocaBancariaComponent, {
      width: '60%',
      data: {}
    });
  }
  ...
  openDialogStorico() {
    this.dialog.open(DialogStoricoBoxRevocaBancariaComponent, {
      width: '60%',
      data: {}
    });
  }
