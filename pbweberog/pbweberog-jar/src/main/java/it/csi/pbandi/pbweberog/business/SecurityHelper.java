...
import it.csi.pbandi.pbweberog.dto.DatiGenerali;
import it.csi.pbandi.pbweberog.exception.BEException;
import it.csi.pbandi.pbweberog.security.UserInfo;
...
//		}
	...
	public boolean verifyCurrentUserForActor(Map session, String actorCode)
			throws  it.csi.pbandi.pbweberog.exception.BEException {
