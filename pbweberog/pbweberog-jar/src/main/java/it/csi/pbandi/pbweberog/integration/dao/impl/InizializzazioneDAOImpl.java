...
import it.csi.pbandi.pbweberog.integration.dao.impl.rowmapper.BeneficiarioRowMapper;
import it.csi.pbandi.pbweberog.integration.vo.BeneficiarioVO;
...
public class InizializzazioneDAOImpl extends JdbcDaoSupport implements InizializzazioneDAO {
	...
	public UserInfoSec completaDatiUtente(Long idPrj, Long idSg, Long idSgBen, Long idU, String role,
		...
		//TODO PK 
		// 1) metto in sessione tutti i parametri che passano nell'url e poi li controllo nei vari servizi che li usano
		// 2) i servizi che usano parametri che non arrivano da url vanno controllati..... vanno riportati i parametri all'utente loggato.. 
		session.setAttribute("idProgetto", idPrj);
...
//		it.csi.pbandi.pbandiworkspace.business.impl.NeofluxBusinessImpl::isAttivitaLocked] isAttivitaLocked: descrBreveAttivitaDICH-DI-SPESA, progetto:19233
		...
		if (idSgBen.compareTo(0L) == 0) { // beneficiario non selezionato
...
//			Verifico che ci sia il beneficiario selezionato per il progetto selezionato
	...
	@Override
	public UserInfoSec aggiornaConUserInfoDTO(UserInfoDTO user, UserInfoSec userInfo) {
