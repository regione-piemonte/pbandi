...
public class LabelTableAccessorDecorator implements TableAccessor {
	...
	static {
		resourceBundle = ResourceBundle.getBundle("conf/beanLabels");
	}
	...
	public LabelTableAccessorDecorator(String key,
		...
		InputStream resourceAsStream = LabelTableAccessorDecorator.class.getClassLoader().getResourceAsStream("conf/beanLabelsOrder.properties");
