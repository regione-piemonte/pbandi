...
////{PROTECTED REGION ID(R670575695) ENABLED START////}
/**
...
public class IstanzaAttivitaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R178151850) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-204870622) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1389024562) ENABLED START*/
