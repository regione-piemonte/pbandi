...
package it.csi.pbandi.pbweberog.pbandisrv.dto.neoflux;

////{PROTECTED REGION ID(R-442654494) ENABLED START////}
/**
...
public class NotificaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1649356312) ENABLED START////}
	/**
	 ...
	 * @generated
	 */
	private java.util.Date dataNotifica = null;

	/**
	 * @generated
	 */
	public void setDataNotifica(java.util.Date val) {
		dataNotifica = val;
	}

	////{PROTECTED REGION ID(R-2089541373) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo dataNotifica. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	...
	////{PROTECTED REGION ID(R640634356) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1946179999) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1750558044) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1319204208) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1210727039) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R498087289) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1781336193) ENABLED START*/
