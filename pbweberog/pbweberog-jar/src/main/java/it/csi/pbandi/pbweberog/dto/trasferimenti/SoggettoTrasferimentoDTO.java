...
////{PROTECTED REGION ID(R-1565807932) ENABLED START////}
/**
 * Inserire qui la documentazione della classe SoggettoTrasferimentoDTO.
 * Consigli:
 * <ul>
...
public class SoggettoTrasferimentoDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1760627073) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-225309695) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1704632124) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-72742265) ENABLED START*/
