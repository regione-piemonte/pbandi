...
public class PbandiRSoggettoProgettoVO extends GenericVO {
	...
	public String toString() {
	    ...
	    temp = DataFilter.removeNull( flagEmailConfermata);
	    if (!DataFilter.isEmpty(temp)) sb.append(" flagEmailConfermata: " + temp + "\t\n");	    
