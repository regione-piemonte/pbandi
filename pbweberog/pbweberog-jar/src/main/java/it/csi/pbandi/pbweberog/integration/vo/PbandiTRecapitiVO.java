...
public class PbandiTRecapitiVO extends GenericVO {
	...
	public PbandiTRecapitiVO (Date dtFineValidita, String fax, String email, BigDecimal idUtenteAgg, Date dtInizioValidita, String telefono, BigDecimal idRecapiti, BigDecimal idUtenteIns, String pec) {
	...
	public String toString() {
	    ...
	    temp = DataFilter.removeNull( pec);
	    if (!DataFilter.isEmpty(temp)) sb.append(" pec: " + temp + "\t\n");
