...
package it.csi.pbandi.pbservizit.pbandisrv.business.richiestaerogazione;
...
import it.csi.pbandi.pbservizit.pbandisrv.dto.richiestaerogazione.IstanzaAttivitaDTO;
...
import it.csi.pbandi.pbservizit.pbandisrv.dto.richiestaerogazione.SpesaProgettoDTO;
...
import it.csi.pbandi.pbservizit.pbandisrv.interfacecsi.richiestaerogazione.RichiestaErogazioneSrv;
				...
				if(idDelegato!=null){
					popolaTemplateManager.addChiave(PopolaTemplateManager.CHIAVE_ID_RAPPRESENTANTE_LEGALE,
						...
						logger.info("il delegato non � NULL "+idDelegato+", lo metto al posto del rapp legale");
						 ...
						 it.csi.pbandi.pbservizit.pbandisrv.dto.manager.RappresentanteLegaleDTO rappresentanteLegale = beanUtil.transform(
									delegatoVO,
					 ...
					 it.csi.pbandi.pbservizit.pbandisrv.dto.manager.RappresentanteLegaleDTO rappresentanteLegale = getRappresentanteLegaleManager().findRappresentanteLegale(idProgetto, 
