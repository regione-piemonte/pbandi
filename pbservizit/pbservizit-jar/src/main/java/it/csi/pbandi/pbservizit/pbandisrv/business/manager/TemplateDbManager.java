...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.SezioneModelloJasperVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipoTemplateVO;
 ...
 */
	...
	public void saveTemplate(Long idUtente,
			...
			throws Exception {
		logger.begin();
		logger.debug("idUtente="+idUtente+ ", idTipoDocumentoIndex="+idTipoDocumentoIndex+", progrBandoLinea="+progrBandoLinea);
	...
	public Modello recuperaModello(BigDecimal idTipoDocumentoIndex,
		...
		if(subReportTemplates!=null) {
			for (TemplateJasperVO templateJasperVO : subReportTemplates) {
