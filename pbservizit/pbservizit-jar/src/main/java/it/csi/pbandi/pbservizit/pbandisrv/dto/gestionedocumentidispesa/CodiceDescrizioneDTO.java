...
////{PROTECTED REGION ID(R-1124850024) ENABLED START////}
/**
...
public class CodiceDescrizioneDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R2058213035) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-330313801) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-70939661) ENABLED START*/
