...
package it.csi.pbandi.pbservizit.pbandiutil.common.dto;
...
public class ContestoIdentificativoDTO {
	...
	public String toString() {
		return "ContestoIdentificativoDTO [idUtente=" + idUtente + ", codFiscale=" + codFiscale + ", cognome=" + cognome
				+ ", nome=" + nome + ", descBreveTipoAnagrafica=" + descBreveTipoAnagrafica + ", idSoggetto="
				+ idSoggetto + ", idIstanzaAttivitaProcesso=" + idIstanzaAttivitaProcesso + ", codUtenteFlux="
				+ codUtenteFlux + ", identitaIride=" + identitaIride + ", taskName=" + taskName + ", ruoloHelp="
				+ ruoloHelp + "]";
	}
