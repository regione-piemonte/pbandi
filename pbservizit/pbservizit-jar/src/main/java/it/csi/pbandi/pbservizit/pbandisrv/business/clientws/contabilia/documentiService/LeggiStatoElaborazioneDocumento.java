...
/**
 * LeggiStatoElaborazioneDocumento.java
 *
...
public class LeggiStatoElaborazioneDocumento  extends it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.documentiService.BaseRequest  implements java.io.Serializable {
    private java.lang.Integer idOperazioneAsincrona;

    public LeggiStatoElaborazioneDocumento() {
    }
    ...
    /**
     * Gets the idOperazioneAsincrona value for this LeggiStatoElaborazioneDocumento.
     * 
    ...
    /**
     * Sets the idOperazioneAsincrona value for this LeggiStatoElaborazioneDocumento.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LeggiStatoElaborazioneDocumento)) return false;
        LeggiStatoElaborazioneDocumento other = (LeggiStatoElaborazioneDocumento) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LeggiStatoElaborazioneDocumento.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://siac.csi.it/documenti/svc/1.0", "leggiStatoElaborazioneDocumento"));
