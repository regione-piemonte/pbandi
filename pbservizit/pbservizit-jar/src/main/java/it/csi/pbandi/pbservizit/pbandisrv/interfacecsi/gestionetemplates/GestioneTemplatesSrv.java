...
package it.csi.pbandi.pbservizit.pbandisrv.interfacecsi.gestionetemplates;

import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionetemplates.*;
import it.csi.pbandi.pbservizit.pbandisrv.exception.gestionetemplates.*;

////{PROTECTED REGION ID(R1735990897) ENABLED START////}
/**
 * Inserire qui la documentazione dell'interfaccia pubblica del servizio gestione_templates.
 * Consigli:
 * <ul>
...
public interface GestioneTemplatesSrv {

	////{PROTECTED REGION ID(R1916496207) ENABLED START////}
	/**
	 * Inserire qui la documentazione del metodo generaTemplate.
	 ...
	 * @throws GestioneTemplatesException
	 ...
	 */
	////{PROTECTED REGION END////}
	public java.lang.String generaTemplate(
	...
	, it.csi.csi.util.DatiMessaggio datiMsg)
			...
			,
			it.csi.pbandi.pbservizit.pbandisrv.exception.gestionetemplates.GestioneTemplatesException;

	////{PROTECTED REGION ID(R1092966781) ENABLED START////}
	/**
	 * Inserire qui la documentazione del metodo findBandoLinea.
	 * Descrivere dettagliatamente:
	 * <ul>
	 * <li>la semantica del metodo (facendo riferimento ai parametri). E'importante 
	 *     elencare casi particolari (dati non trovati, ecc...)
	 ...
	 * @return it.csi.pbandi.pbandisrv.dto.gestionetemplates.BandoLinea[]
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionetemplates.BandoLinea[] findBandoLinea(
	...
	////{PROTECTED REGION ID(R1174851366) ENABLED START////}
	/**
	 * Inserire qui la documentazione del metodo anteprimaTemplate.
	 * Descrivere dettagliatamente:
	 * <ul>
	 * <li>la semantica del metodo (facendo riferimento ai parametri). E'importante 
	 *     elencare casi particolari (dati non trovati, ecc...)
	 ...
	 * @param idTemplate [documentazione del parametro (vedere sopra per consigli sulla documentazione)]
	 	
	 
	 * @return it.csi.pbandi.pbandisrv.dto.gestionetemplates.EsitoAnteprimaTemplateDTO
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionetemplates.EsitoAnteprimaTemplateDTO anteprimaTemplate(
	...
	////{PROTECTED REGION ID(R346583900) ENABLED START////}
	/**
	 * Inserire qui la documentazione del metodo findModelli.
	 * Descrivere dettagliatamente:
	 * <ul>
	 * <li>la semantica del metodo (facendo riferimento ai parametri). E'importante 
	 *     elencare casi particolari (dati non trovati, ecc...)
	 ...
	 * @return it.csi.pbandi.pbandisrv.dto.gestionetemplates.TemplateDTO[]
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionetemplates.TemplateDTO[] findModelli(
	...
	////{PROTECTED REGION ID(R1355323427) ENABLED START////}
	/**
	 * Inserire qui la documentazione del metodo visualizzaTemplate.
	 * Descrivere dettagliatamente:
	 * <ul>
	 * <li>la semantica del metodo (facendo riferimento ai parametri). E'importante 
	 *     elencare casi particolari (dati non trovati, ecc...)
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionetemplates.EsitoAnteprimaTemplateDTO visualizzaTemplate(

	java.lang.Long idUtente,

	java.lang.String identitaDigitale,

	java.lang.Long idTemplate
