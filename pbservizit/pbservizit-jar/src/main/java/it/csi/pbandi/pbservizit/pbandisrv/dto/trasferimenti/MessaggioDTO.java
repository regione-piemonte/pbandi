...
////{PROTECTED REGION ID(R1181155002) ENABLED START////}
/**
...
public class MessaggioDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R8146520) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R77759680) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1790453329) ENABLED START*/
