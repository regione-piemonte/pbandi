...
////{PROTECTED REGION ID(R-1654808779) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoOperazioneAnteprimaComunicazioneFineProgetto.
 * Consigli:
 * <ul>
...
public class EsitoOperazioneAnteprimaComunicazioneFineProgetto
		implements
	...
	////{PROTECTED REGION ID(R-410796255) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1975484010) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-237666098) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1618121418) ENABLED START*/
