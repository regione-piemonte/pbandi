...
public class EsitoOperazioneDocumentoDiSpesa implements java.io.Serializable {
	 ...
	 * @generated
	 */
	private it.csi.pbandi.pbservizit.pbandisrv.dto.gestionedocumentidispesa.MessaggioDTO[] messaggi = null;

	/**
	 * @generated
	 */
	public void setMessaggi(
			it.csi.pbandi.pbservizit.pbandisrv.dto.gestionedocumentidispesa.MessaggioDTO[] val) {
		messaggi = val;
	}
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionedocumentidispesa.MessaggioDTO[] getMessaggi() {
		return messaggi;
	}
