...
////{PROTECTED REGION ID(R1599202504) ENABLED START////}
/**
...
public class MessaggioDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-4591130) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R65022030) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1640905319) ENABLED START*/
