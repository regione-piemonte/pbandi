...
package it.csi.pbandi.pbservizit.pbandisrv.exception.trasferimenti;

import it.csi.csi.wrapper.SystemException;
import it.csi.csi.wrapper.UserException;
import it.csi.csi.wrapper.UnrecoverableException;

////{PROTECTED REGION ID(R1331908468) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione TrasferimentiException.
 * Consigli:
 * <ul>
...
public class TrasferimentiException extends UserException

{
	 ...
	 * @generated
	 */
	public TrasferimentiException(String msg, String nestedExcClassName,
	 ...
	 * @generated
	 */
	public TrasferimentiException(String msg, Throwable nested) {
		super(msg, nested);
	}
	 ...
	 * @generated
	 */
	public TrasferimentiException(String msg) {
		super(msg);
	}
}
