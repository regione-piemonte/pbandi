...
package it.csi.pbandi.pbservizit.pbandisrv.business.gestionebackoffice;
...
import it.csi.pbandi.pbservizit.pbandisrv.business.manager.ComuniManager;
...
import it.csi.pbandi.pbservizit.pbandisrv.business.manager.VoceDiSpesaManager;
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.AllegatoAssociatoDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.AreaScientificaDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.AtecoAmmessoDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.AtecoInclusoEsclusoDTO;
...
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.DefinizioneProcessoDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.DettTipolAiutiAssociatoDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.DettTipolInterventoDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.DettaglioBandoLinea;
...
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoGeneraParolaChiaveActa;
...
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.InterventoAssociatoDTO;
...
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.PremialitaDTO;
...
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.SportelloBandoDTO;
...
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.TipolInterventoDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.TipologiaBeneficiarioDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.UtenteRicercatoDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.VoceDiEntrataDTO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.dao.PbandiBackOfficeDAOImpl;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.AllegatoAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.AtecoEsclusoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.AtecoInclusoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoCausaleDiErogazioneAssociataVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoIndicatoreAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoLineaEnteCompAttiviVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoLineaIndicatoreQSNAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoLineaIndicatoriRisultatoProgrammaAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoLineaTemaPrioritarioAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoLineaTipoAiutoAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoLineaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoSifNonAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoSoggettoFinanziatoreAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoTipoTrattamentoAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BeneficiarioProgettoAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BeneficiarioProgettoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.DettTipolAiutiAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.DettTipolAiutiVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.DettaglioAllSoggettiConTipoAnagraficaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.DettaglioSoggettoConTipoAnagraficaSenzaBeneficiarioVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.DettaglioSoggettoConTipoAnagraficaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.DettaglioSoggettoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.EnteDiCompetenzaAssociataVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.EnteDiCompetenzaProgSoggVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.EnteDiCompetenzaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.EsisteProgettoBandoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.IndicatoriCodIgrueVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.InterventoAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.MaxProgrOrdinamentoVoceDiSpesaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.ModalitaDiAgevolazioneBandoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.PermessoTipoAnagraficaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.PersonaFisicaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.PremialitaAssociataVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.ProgettoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.RegolaAssociataAnagraficaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.RegolaAssociataBandoLineaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.SettoreEnteBandoRuoloVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.SezioneContenutoVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.SoggettoPermessoTipoAnagraficaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.SoggettoProgettoRuoloProcessoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.VoceDiEntrataAssociataVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.VoceDiSpesaAssociataVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.VoceDiSpesaInterventoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.VociDiSpesaAssociateABandoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.VociDiSpesaConIdVoceDiSpesaPadreVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionebackoffice.BandoVO;
//import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionebackoffice.BeneficiarioEnteGiuridico;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionebackoffice.BeneficiarioVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionebackoffice.DatiBeneficiarioProgettoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionebackoffice.IstruttoreVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionebackoffice.SoggettoEnteGiuridicoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.util.AndCondition;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.util.BetweenCondition;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.util.FilterIgnoreCaseCondition;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.util.OrCondition;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.GenericVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiCDefinizioneProcessoVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDAllegatiVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDAreaScientificaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDCampiInterventoVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDDettTipolAiutiVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDDettTipolInterventiVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDMateriaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDMicroSezioneModuloVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDModalitaPagamentoVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDPremialitaVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDSoggettoFinanziatoreVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipoDocumentoSpesaVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipolBeneficiariVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipolInterventiVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDVoceDiEntrataVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDVoceDiSpesaMonitVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDVoceDiSpesaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBanLineaIntTemPriVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandiAllegatiVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandiAtecoEsclVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandiAtecoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandiDettTipAiutiVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandiPremialitaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandiTipolIntervVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandoCausErTipAllVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandoLinTipoAiutoVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandoLineaPeriodoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandoLineaSettoreVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandoModalitaAgevolVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandoSoggFinanziatVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandoTipoTrattamentVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandoVoceEntrataVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBandoVoceSpesaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBlTipoDocMicroSezVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRBlTipoDocSezModVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRDettTipolIntVocSpVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiREccezBanLinDocPagVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRRegolaTipoAnagVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRTipoDocModalitaPagVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRTipolBenBandiVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRTipolIntervVociSpeVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTFlussiUploadVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTSportelliBandiVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTUtenteVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiVAtecoAmmessiVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiWCostantiVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiWCspCostantiVO;
import it.csi.pbandi.pbservizit.pbandisrv.interfacecsi.gestionebackoffice.GestioneBackofficeSrv;
...
public class GestioneBackofficeBusinessImpl extends BusinessImpl implements
	...
	@Autowired
	private PbandiBackOfficeDAOImpl pbandiBackOfficeDAO;
	@Autowired
	...
	@Autowired
	private PbandiBackOfficeDAOImpl pbandiBackOfficeDAOImpl;
			...
			for (IstruttoreVO istruttoreVO : istruttoriVO) {
				...
				List<ProgettoVO> progettiAssociatiVO = pbandiBackOfficeDAO
						.findProgettiAssociatiIstruttore(istruttore
								.getIdSoggetto(), true, filtro.getDescBreveTipoAnagrafica());
				...
				/*
				 * ricerco i bandi-linea associati ad ogni istruttore
				 */
				List<BandoLineaAssociatoDTO> bandiLineaAssociatiVO = pbandiBackOfficeDAO
						.findBandiLineaAssociatiIstruttore(istruttore
								.getIdSoggetto(), true, filtro.getDescBreveTipoAnagrafica());
				BandoLineaAssociatoDTO[] bandiLineaAssociatiDTO = new BandoLineaAssociatoDTO[bandiLineaAssociatiVO
						.size()];
				beanUtil.valueCopy(bandiLineaAssociatiVO.toArray(),
						bandiLineaAssociatiDTO);
				istruttore.setBandiLineaAssociati(bandiLineaAssociatiDTO);
				istruttore.setTotaleBandiLineaAssociati(new Long(
						bandiLineaAssociatiVO.size()));
	...
	public ProgettoDTO[] findProgettiAssociatiAIstruttore(Long idUtente,
			...
			List<ProgettoVO> progettiVO = pbandiBackOfficeDAO
					.findProgettiAssociatiIstruttore(idSoggettoIstruttore, true, null);
	...
	public ProgettoDTO[] findDettaglioProgettiAssociatiAIstruttore(
			Long idUtente, String identitaDigitale, Long idSoggettoIstruttore, Boolean isIstruttoreAffidamenti)
			throws CSIException, SystemException, UnrecoverableException,
			GestioneBackOfficeException {
			String[] nameParameter = { "idUtente", "identitaDigitale",
					"idSoggettoIstruttore" };
			...
			List<ProgettoVO> progettiVO = pbandiBackOfficeDAO
					.findDettaglioProgettiAssociatiIstruttore(idSoggettoIstruttore, isIstruttoreAffidamenti);
			ProgettoDTO[] progetti = null;
			if (progettiVO != null) {
				progetti = new ProgettoDTO[progettiVO.size()];
				beanUtil.valueCopy(progettiVO.toArray(), progetti);
	...
	public ProgettoDTO[] findProgettiByBandoLinea(Long idUtente,
			...
			List<ProgettoVO> progettiVO = pbandiBackOfficeDAO
					.findProgettiByBandoLinea(idBandoLinea);
	...
	public BeneficiarioProgettoDTO[] findBeneficiari(Long idUtente,
			String identitaDigitale, Long idBandoLinea, Long idProgetto)
			throws CSIException, SystemException, UnrecoverableException,
			GestioneBackOfficeException {
			String[] nameParameter = { "idUtente", "identitaDigitale",
					"idBandoLinea" };
			...
			List<BeneficiarioVO> beneficiariVO = pbandiBackOfficeDAO
					.findBeneficiariProgetto(idProgetto, idBandoLinea, null);
	...
	public ProgettoDTO[] findProgettiDaAssociare(Long idUtente,
			...
			boolean isIstruttoriAssociati, Boolean isIstruttoreAfffidamenti) throws CSIException,
			SystemException, UnrecoverableException,
			GestioneBackOfficeException {
			String[] nameParameter = { "idUtente", "identitaDigitale",
					"idBandoLinea", "isIstruttoriAssociati" };
			ValidatorInput.verifyNullValue(nameParameter, idUtente,
					identitaDigitale, idBandoLinea, isIstruttoriAssociati);
			/*
			 * Cerco i progetti da associare
			 */
			List<ProgettoVO> progettiDaAssociareVO = pbandiBackOfficeDAO
					.findProgettiDaAssociare(idBandoLinea, idProgetto,
							isIstruttoriAssociati, isIstruttoreAfffidamenti);
			...
			for (ProgettoVO progettoVO : progettiDaAssociareVO) {
				...
				if (isIstruttoriAssociati) {
					...
					List<IstruttoreVO> istruttoriAssociatiVO = pbandiBackOfficeDAO
							.findIstruttoriAssociatiAProgetto(idSoggettoMaster,
							        idBandoLinea, progettoVO.getIdProgetto(), isIstruttoreAfffidamenti);
				...
				if (progettoDaAssociare) {
					...
					List<BeneficiarioVO> beneficiari = pbandiBackOfficeDAO
							.findBeneficiariProgetto(idProgetto, idBandoLinea, idSoggettoBeneficiario);
					/*
	...
	public ProgettoDTO[] findProgettiBeneficiarioBando(Long idUtente,
			String identitaDigitale, Long idBandoLinea, Long idSoggettoBeneficiario)
			throws CSIException, SystemException, UnrecoverableException,
			GestioneBackOfficeException {
			String[] nameParameter = { "idUtente", "identitaDigitale",
					"idBandoLinea", "idSoggettoBeneficiario" };
			ValidatorInput.verifyNullValue(nameParameter, idUtente,
					identitaDigitale, idBandoLinea, idSoggettoBeneficiario);
	...
	public EsitoOperazioneAssociaProgettiAIstruttore associaProgettiAIstruttore(
			...
			Long idIstruttore, Long idIstruttoreMaster, String codRuolo, Boolean isIstruttoreAffidamenti)
			throws CSIException, SystemException, UnrecoverableException,
			GestioneBackOfficeException {
			...
			if(isIstruttoreAffidamenti == null || isIstruttoreAffidamenti.equals(Boolean.FALSE)) {
				 ...
				 * ADG-ISTRUTTORE
				 */
				decodifica = createRuoloIstruttoreSemplice(
						idIstruttoreMaster, codRuolo);
			} else {
				decodifica = decodificheManager
				.findDecodifica(GestioneDatiDiDominioSrv.TIPO_ANAGRAFICA, Constants.RUOLO_ISTR_AFFIDAMENTI);
			}
	...
	public IstruttoreDTO[] findIstruttoriSempliciAssociatiProgetto(
			Long idUtente, String identitaDigitale,
			Long idSoggettoIstruttoreMaster, Long idBando, Long idProgetto, Boolean isIstruttoreAffidamenti)
			throws CSIException, SystemException, UnrecoverableException,
			GestioneBackOfficeException {
			String[] nameParameter = { "idUtente", "identitaDigitale",
			...
			List<IstruttoreVO> istruttoriVO = pbandiBackOfficeDAO
					.findIstruttoriAssociatiAProgetto(
							idSoggettoIstruttoreMaster, idBando, idProgetto, isIstruttoreAffidamenti);
	...
	public BandoDTO[] findBandiConfigurabili(Long idUtente,
			...
			Long idModalitaAttivazione, Long idLineaDiIntervento) throws CSIException,
			SystemException, UnrecoverableException,
			GestioneBackOfficeException {
			String[] nameParameter = { "idUtente", "identitaDigitale" };
			ValidatorInput.verifyNullValue(nameParameter, idUtente,
...
//			}
			...
			if (bandoDaTrovare != null && bandoDaTrovare.getIdBando() != null
				...
				try {
					...
					if (queryVO.getIdLineaDiIntervento() != null) {
						int idProcessoCultura = it.csi.pbandi.pbservizit.pbandisrv.util.Constants.ID_PROCESSO_CULTURA;
		...
		try {
			...
			if (idLineaPadre == null) {
				...
				*/
				...
				if (it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PROGRAMMAZIONE_PRE_2016.equalsIgnoreCase(tipoProgrammazione))
				{
				...
				} else if (it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PROGRAMMAZIONE_2016.equalsIgnoreCase(tipoProgrammazione)) {
					// Considera le linee con data > = 2016
					for (PbandiDLineaDiInterventoVO vo : listaVO) {
						if (!(vo.getDtInizioValidita().before(data2016)))
							listaVORidotta.add(vo);
	...
	public EsitoAssociazione associaLineaDiIntervento(Long idUtente,
		...
		try {
			...
			try {
				...
				//se flagSif=N controllo se ci sono indicatori per il bando sif progrBandoLineaIntervSif
				if ((vo.getFlagSif() == null || vo.getFlagSif().equals("N")) && vo.getProgrBandoLineaIntervSif() != null) {
					
					//recupero idBando del bando sif con progrBandoLineaIntervSif
					PbandiRBandoLineaInterventVO pbandiRBandoLineaInterventSifVO = new PbandiRBandoLineaInterventVO();
					pbandiRBandoLineaInterventSifVO.setProgrBandoLineaIntervento(vo.getProgrBandoLineaIntervSif());
					pbandiRBandoLineaInterventSifVO = genericDAO.findSingleWhere(pbandiRBandoLineaInterventSifVO);
					
					//conto indicatori associati al bando sif
					PbandiRBandoIndicatoriVO bandoIndicSifVo = new PbandiRBandoIndicatoriVO();
					bandoIndicSifVo.setIdBando(pbandiRBandoLineaInterventSifVO.getIdBando());
					int count = genericDAO.count(bandoIndicSifVo);
					if (count > 0) {
						//elimino indicatori associati al bando corrente
						PbandiRBandoIndicatoriVO bandoIndicVo = new PbandiRBandoIndicatoriVO();
						bandoIndicVo.setIdBando(vo.getIdBando());
						List<PbandiRBandoIndicatoriVO> indicAssociatiBando = genericDAO.findListWhere(bandoIndicVo);
						if (indicAssociatiBando != null && indicAssociatiBando.size() > 0) {
							for(PbandiRBandoIndicatoriVO ind : indicAssociatiBando) {
								boolean result = genericDAO.delete(ind);
								if(!result) {
									logger.error("Errore durante la cancellazione degli indicatori associati al bando.");
									throw new Exception("Errore durante la cancellazione degli indicatori associati al bando.");
								}
							}
						}
	
						//recupero indicatori associati al bando sif
						List<PbandiRBandoIndicatoriVO> indicatoriBandoSif = genericDAO.findListWhere(bandoIndicSifVo);
						
						if (indicatoriBandoSif != null && indicatoriBandoSif.size() > 0) {
							//li copio e li associo al bando
							List<PbandiRBandoIndicatoriVO> indicatoriBando = new ArrayList<>();
							for (PbandiRBandoIndicatoriVO ind : indicatoriBandoSif) {
								PbandiRBandoIndicatoriVO indCopia = new PbandiRBandoIndicatoriVO();
								indCopia.setIdBando(vo.getIdBando());
								indCopia.setIdIndicatori(ind.getIdIndicatori());
								indCopia.setIdUtenteIns(new BigDecimal(idUtente.longValue()));
								indCopia.setIdUtenteAgg(new BigDecimal(idUtente.longValue()));
								indCopia.setInfoIniziale(ind.getInfoIniziale());
								indCopia.setInfoFinale(ind.getInfoFinale());
								indicatoriBando.add(indCopia);
							}
							genericDAO.insert(indicatoriBando);
						}
						vo = genericDAO.insert(vo);
						esito.setEsito(null);
						...
						esito
								.setMessage("Associazione avvenuta con successo. Gli Indicatori associati al Bando SIF collegato sono stati associati al Bando corrente. Gli eventuali indicatori già associati al Bando corrente sono stati sovrascritti.");
					} else {
						esito.setEsito(null);
						esito
								.setMessage("Attenzione! Per poter procedere è necessario associare almeno un indicatore al Bando SIF collegato.");
					}
				} else {
					vo = genericDAO.insert(vo);
					esito.setEsito(true);
			...
			if((esito.getEsito() == null && esito.getIdAssociazione() != null) || (esito.getEsito() != null && esito.getEsito().equals(Boolean.TRUE))) {
	...
	public EsitoAssociazione associaEnteDiCompetenza(Long idUtente, 
			...
			Long idEnte, Long idRuoloEnte,Long idSettoreEnte, String pec, String mail, String tipoProgrammazione, 
			Long conservazioneCorrente, Long conservazioneGenerale) throws CSIException,
			SystemException, UnrecoverableException,
			GestioneBackOfficeException {
		EsitoAssociazione esito = new EsitoAssociazione();
		esito.setEsito(false);
		try {
			...
			vo.setIndirizzoMail(mail);
			if (conservazioneCorrente != null)
				vo.setConservazioneCorrente(new BigDecimal(conservazioneCorrente));
			if (conservazioneGenerale != null)
			vo.setConservazioneGenerale(new BigDecimal(conservazioneGenerale));
			...
			try {
				...
				if (!idEnteCompetenzaFindom.equals(idEnte) &&
						   ...
						   it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PROGRAMMAZIONE_2016.equals(tipoProgrammazione)) {
	...
	public IdDescBreveDescEstesa2DTO[] findVociDiSpesaAssociate(Long idUtente,
		...
		try {
			...
			map.put("flagSpeseGestione", "info4");
	...
	public EsitoAssociazione associaModalitaDiAgevolazione(Long idUtente,
			...
			Double massimoImportoAgevolato, String flagLiquidazione, Double minimoImportoAgevolato, Double periodoStabilita, Double importoDaErogare) throws CSIException,
			SystemException, UnrecoverableException,
			GestioneBackOfficeException {
		EsitoAssociazione esito = new EsitoAssociazione();
		esito.setEsito(false);
		try {
			...
			try {
				...
				if (associazioneEsistente.isEmpty()) {
					...
					vo.setIdModalitaAgevolazione(new BigDecimal(idModalitaDiAgevolazione));
					vo.setIdBando(new BigDecimal(idBando));
					vo.setMassimoImportoAgevolato(massimoImportoAgevolato == null ? null: new BigDecimal(massimoImportoAgevolato));
					vo.setPercentualeImportoAgevolato(importoAgevolato == null ? null: new BigDecimal(importoAgevolato));
					vo.setIdUtenteIns(new BigDecimal(idUtente));
					vo.setPeriodoStabilita(periodoStabilita == null ? null : new BigDecimal(periodoStabilita ));
					vo.setFlagLiquidazione(flagLiquidazione);
					vo.setMinimoImportoAgevolato(minimoImportoAgevolato == null ? null : new BigDecimal(minimoImportoAgevolato));
					vo.setPercentualeImportoDaErogare(importoDaErogare == null ? null : new BigDecimal(importoDaErogare ));
	...
	public EsitoAssociazione associaIndicatore(Long idUtente,
			String identitaDigitale, Long idBando, Long idIndicatore, String infoIniziale, String infoFinale)
			throws CSIException, SystemException, UnrecoverableException,
			GestioneBackOfficeException {
		EsitoAssociazione esito = new EsitoAssociazione();
		esito.setEsito(false);
		try {
			...
			try {
				...
				vo.setInfoIniziale(infoIniziale);
				vo.setInfoFinale(infoFinale);
				
				if (genericDAO.findListWhere(vo).isEmpty()) {
					vo.setIdUtenteIns(new BigDecimal(idUtente));
					vo = genericDAO.insert(vo);
					
					//recupero flagSif da idBando
					PbandiRBandoLineaInterventVO pbandiRBandoLineaInterventVO = new PbandiRBandoLineaInterventVO();
					pbandiRBandoLineaInterventVO.setIdBando(new BigDecimal(idBando.longValue()));
					List<PbandiRBandoLineaInterventVO> pbandiRBandoLineaInterventVOs = genericDAO.findListWhere(pbandiRBandoLineaInterventVO);
					
					if (pbandiRBandoLineaInterventVOs != null && pbandiRBandoLineaInterventVOs.size() > 0) {
						for (PbandiRBandoLineaInterventVO bandoLinea : pbandiRBandoLineaInterventVOs) {
							
							//controllo se la linea e' la 21-27
							PbandiDLineaDiInterventoVO pbandiDLineaDiInterventoVO = new PbandiDLineaDiInterventoVO();
							pbandiDLineaDiInterventoVO.setIdLineaDiIntervento(bandoLinea.getIdLineaDiIntervento());
							pbandiDLineaDiInterventoVO = genericDAO.findSingleWhere(pbandiDLineaDiInterventoVO);
							if(bandoLinea.getFlagSif() != null && bandoLinea.getFlagSif().equals("S") 
									&& pbandiDLineaDiInterventoVO != null && pbandiDLineaDiInterventoVO.getDescBreveLinea().equals(Constants.DESC_BREVE_LINEA_POR_FESR_21_27)) {
								//bando siffone, aggiungo l'indicatore anche al siffino
								
								//recupero siffini
								PbandiRBandoLineaInterventVO pbandiRBandoLineaInterventSifVO = new PbandiRBandoLineaInterventVO();
								pbandiRBandoLineaInterventSifVO.setProgrBandoLineaIntervSif(bandoLinea.getProgrBandoLineaIntervento());
								List<PbandiRBandoLineaInterventVO> siffini = genericDAO.findListWhere(pbandiRBandoLineaInterventSifVO);
								
								if ( siffini != null && siffini.size() > 0) {
									for (PbandiRBandoLineaInterventVO siffino : siffini) {
										PbandiRBandoIndicatoriVO indCopia = new PbandiRBandoIndicatoriVO();
										indCopia.setIdBando(siffino.getIdBando());
										indCopia.setIdIndicatori(new BigDecimal(idIndicatore));
										indCopia.setIdUtenteIns(new BigDecimal(idUtente.longValue()));
										indCopia.setInfoIniziale(infoIniziale);
										indCopia.setInfoFinale(infoFinale);
										genericDAO.insert(indCopia);
									}
									
									esito.setEsito(true);
									esito
											.setMessage("Associazione avvenuta con successo. L'indicatore è stato associato anche al bando percettore.");
								}
							}
						}
					}
					...
					if(esito.getEsito().equals(Boolean.FALSE)) {
						esito.setEsito(true);
						esito
								.setMessage("Associazione avvenuta con successo.");
					}
				} else {
					esito.setEsito(false);
					esito.setMessage(ERRORE_OCCORRENZA_GIA_PRESENTE);
		...
		try {
			...
			if (pbandiRBandoLineaInterventVOs != null && pbandiRBandoLineaInterventVOs.size() > 0) {
				for (PbandiRBandoLineaInterventVO bandoLinea : pbandiRBandoLineaInterventVOs) {
					...
					if(bandoLinea.getFlagSif() != null && bandoLinea.getFlagSif().equals("S")
							&& pbandiDLineaDiInterventoVO != null && pbandiDLineaDiInterventoVO.getDescBreveLinea().equals(Constants.DESC_BREVE_LINEA_POR_FESR_21_27)) {
						//bando siffone, elimino l'indicatore anche dal siffino
						...
						if ( siffini != null && siffini.size() > 0) {
							for (PbandiRBandoLineaInterventVO siffino : siffini) {
								...
								indCopia.setIdBando(siffino.getIdBando());
								indCopia.setIdIndicatori(new BigDecimal(idIndicatore));
								esito.setEsito(genericDAO.delete(indCopia));
								if (!esito.getEsito()) {
									throw new Exception();
								}
							}
							...
							esito.setEsito(true);
							esito
									.setMessage("Cancellazione avvenuta con successo. L'indicatore è stato cancellato anche dal bando percettore.");
						}
					}
				}
			}
			if(esito.getMessage() == null || esito.getMessage().isEmpty()) {
				esito
	...
	public IdDescBreveDescEstesa2DTO[] findIndicatoriAssociati(Long idUtente,
			String identitaDigitale, Long idBando) throws CSIException,
			SystemException, UnrecoverableException,
			GestioneBackOfficeException {
		try {
			...
			List<BandoIndicatoreAssociatoVO> vo = genericDAO
					.findListWhere(query);
			IdDescBreveDescEstesa2DTO[] dto = new IdDescBreveDescEstesa2DTO[vo
					.size()];
			Map<String, String> map = new HashMap<String, String>();
			map.put("codIgrue", "descBreve");
			map.put("descIndicatoreLinea", "descEstesa");
			map.put("idIndicatori", "id");
			map.put("infoIniziale", "info");
			map.put("infoFinale", "info2");
			beanUtil.valueCopy(vo.toArray(), dto, map);
			return dto;
		} catch (Exception e) {
			throw new UnrecoverableException(
	 ...
	 * 
	 * @see
	 * it.csi.pbandi.pbservizit.pbandisrv.interfacecsi.gestionebackoffice.GestioneBackofficeSrv
	...
	public GestioneBackOfficeEsitoGenerico eliminaUtente(Long idUtente,
		...
		try {
			...
			if (enteCompetenzaSogg.contains(descBreveTipoAnagraficaSoggetto)) {
				...
				tec
						.setDescBreveEnte(it.csi.pbandi.pbservizit.pbandisrv.util.Constants.DESCRIZIONE_BREVE_ENTE_FINPIEMONTE);
	...
	private Boolean isRuoloADG(String codiceRuolo) {
		return (Constants.RUOLO_ADG_IST_MASTER.equals(codiceRuolo))
				...
				|| (Constants.RUOLO_ISTR_AFFIDAMENTI.equals(codiceRuolo)));
	}
	...
	private List<EnteDiCompetenzaVO> getEntiAssociatiSoggetto(
		...
		//Tipo ente di competenza e' schiantato perche' mi e' stato detto di fare così perche'
		//non si poteva aggiungere nel DB quets associazione
		String tipoEnteCompetenza;		
		if(descBreveTipoAnagrafica.equals("ISTR-AFFIDAMENTI"))
			tipoEnteCompetenza = "ADG";
		else {		
		tipoEnteCompetenza = descBreveTipoAnagrafica.contains("-") ? descBreveTipoAnagrafica
	...
	public GestioneBackOfficeEsitoGenerico inserisciAssociazioneBeneficiarioProgetto(
		...
		try {
			...
			return associaBeneficiarioProgetto(idUtente, idSoggetto,
					...
					isRappresentanteLegale, ruolo, idSoggettoOperante, Boolean.FALSE);
		} catch (Exception e) {
			throw new GestioneBackOfficeException(e.getMessage(), e);
		}  
	}
	...
	private GestioneBackOfficeEsitoGenerico associaBeneficiarioProgetto(
			...
			String ruolo,Long idSoggettoOperante, Boolean isModifica)
			throws Exception {
		GestioneBackOfficeEsitoGenerico esito = new GestioneBackOfficeEsitoGenerico();
		esito.setEsito(false);
		esito.setMessage("Non \u00E8 stato possibile portare a termine l\u2019 operazione.");
		...
		if (beneficiarioProgetto.isEmpty()) {
			//throw new GestioneBackOfficeException(ERRORE_BENEFICIARIO_PROGETTO_INCOERENTI);
			esito.setMessage("I dati relativi a beneficiario e progetto sono incoerenti, impossibile salvare.");
			return esito;
		}
		...
		if (ruolo.equalsIgnoreCase(Constants.RUOLO_ADG_IST_MASTER) ||
			...
			if (isEmpty(ret)) {
				...
				esito.setMessage("Attenzione! Il progetto indicato \u00E8 relativo ad un ente che non \u00E8 tra quelli di competenza dell'operatore.");
				return esito;
			}
		}
		...
		if (benProg.size() > 0 && isModifica.equals(Boolean.FALSE)) {
			// Trovato qualcosa
			//throw new GestioneBackOfficeException(ERRORE_UTENTE_GIA_ASSOCIATO_BENEFICIARIO_PROGETTO);
			esito.setMessage("L\u2019utente risulta gi\u00E0 associato al beneficiario e al progetto. Impossibile salvare.");
			return esito;
			/**
		...
		final String soggettoCorrelato = isRappresentanteLegale ? it.csi.pbandi.pbservizit.pbandisrv.util.Constants.DESCRIZIONE_BREVE_TIPO_SOGG_CORRELATO_RAPPRESENTANTE_LEGALE
				: it.csi.pbandi.pbservizit.pbandisrv.util.Constants.DESCRIZIONE_BREVE_TIPO_SOGG_CORRELATO_ND;
		...
		esito.setEsito(true);
		esito.setMessage("Salvataggio avvenuto con successo.");
		return esito;
	}
			...
			final BigDecimal idTipoSoggettoPersonaFisica = new BigDecimal(
					decodificheManager
							.findDecodifica(
									...
									it.csi.pbandi.pbservizit.pbandisrv.util.Constants.DESCRIZIONE_BREVE_TIPO_SOGG_PERSONA_FISICA)
							.getId());
			...
			if (dettaglio.getIdSoggetto() == null) {
				...
				if (soggettiEsistenti.length == 0) {
					...
					tipoAccessoCertificato
							.setCodTipoAccesso(it.csi.pbandi.pbservizit.pbandisrv.util.Constants.CODICE_TIPO_ACCESSO_CERTIFICATO);
	...
	private List<DettaglioSoggettoConTipoAnagraficaSenzaBeneficiarioVO> findSoggettoEsistente(
		...
		if (isCollisioneMasterNonMaster(tipoAnagrafica, queryExist
			...
			throw new GestioneBackOfficeException("Il ruolo scelto non è compatibile con i ruoli già esistenti.");
		}
...
//			if (esito.getEsito()) {
				return associaBeneficiarioProgetto(idUtente, idSoggetto,
						codiceFiscaleBeneficiario, codiceVisualizzatoProgetto,
						isRappresentanteLegale,ruolo,idSoggettoOperante, Boolean.TRUE);
//			} else {
//				return esito;
//			}
//   --------------------------------------------------------------------------------------
	...
	public EsitoAssociazione associaTipoPeriodo(Long idUtente,
		...
		try {
			...
			try {
				...
				if (genericDAO.findListWhere(vo).isEmpty()) {
					vo.setIdUtenteIns(new BigDecimal(idUtente));
//					25-09-2023 idPeriodo non serve piu, forzato a 11 per tutti, eseguo codice per tutti
...
//					25-09-2023 idPeriodo non serve piu, forzato a 11 per tutti, eseguo codice per tutti
	...
	public EsitoAssociazione associaCostantiBandoLinea(Long idUtente, String identitaDigitale, CostantiBandoLineaDTO costantiBandoLinea) 
		...
		try {
			...
			voSearch.setAttributo(it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_PROGR_BANDO_LINEA_INTERVENTO);
			...
			vo.setAttributo(it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_CODICE_PROGETTO_NORMATIVA);
			...
			vo.setAttributo(it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_PROGR_BANDO_LINEA_INTERVENTO);
			vo.setValore(costantiBandoLinea.getProgrBandoLineaIntervento().toString());
			genericDAO.insert(vo);
							
			// Inserisco la costante con attributo STATO_DOMANDA
			vo.setAttributo(it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_STATO_DOMANDA);
			vo.setValore(costantiBandoLinea.getIdStatoDomanda().toString());
			genericDAO.insert(vo);

			// Inserisco la costante con attributo STATO_INVIO_DOMANDA
			vo.setAttributo(it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_STATO_INVIO_DOMANDA);
			vo.setValore(costantiBandoLinea.getStatoInvioDomanda().toString());
			genericDAO.insert(vo);

			// Inserisco la costante con attributo STATO_PROGETTO
			vo.setAttributo(it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_STATO_PROGETTO);
			vo.setValore(costantiBandoLinea.getStatoProgetto().toString());
			genericDAO.insert(vo);
			
			// Inserisco la costante con attributo TIPO_OPERAZIONE
			vo.setAttributo(it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_TIPO_OPERAZIONE);
			vo.setValore(costantiBandoLinea.getIdTipoOperazione().toString());
			genericDAO.insert(vo);
			
			// Inserisco la costante con attributo STATO_CONTO_ECONOMICO
			vo.setAttributo(it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_STATO_CONTO_ECONOMICO);
	...
	public CostantiBandoLineaDTO findCostantiBandoLinea(
		...
		try {
			...
			String codProgettoNormativa = it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_CODICE_PROGETTO_NORMATIVA;
			String statoDomanda = it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_STATO_DOMANDA;			
			String tipoOperazione = it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_TIPO_OPERAZIONE;			
			String statoInvioDomanda = it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_STATO_INVIO_DOMANDA;
			String statoProgetto = it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_STATO_PROGETTO;
			String statoContoEconomico = it.csi.pbandi.pbservizit.pbandisrv.util.Constants.PBANDI_W_COSTANTI_ATTRIBUTO_STATO_CONTO_ECONOMICO;
	...
	public LineaDiInterventiDaModificareDTO findLineaDiIntervento(Long idUtente,
		...
		try {
			...
			if (pbandiRBandoLineaInterventVO.getProgrBandoLineaIntervSif() != null) {
				PbandiRBandoLineaInterventVO pbandiRBandoLineaInterventSifVO = new PbandiRBandoLineaInterventVO(); 			
				pbandiRBandoLineaInterventSifVO.setProgrBandoLineaIntervento(pbandiRBandoLineaInterventVO.getProgrBandoLineaIntervSif());
				pbandiRBandoLineaInterventSifVO = genericDAO.findSingleOrNoneWhere(pbandiRBandoLineaInterventSifVO);
				lineaDiInterventiDaModificareDTO.setNomeBandoLineaSif(pbandiRBandoLineaInterventSifVO.getNomeBandoLinea());
			}
			...
			if (pbandiRBandoLineaInterventVO.getIdLineaDiIntervento() != null) {
				...
				String descNormativa = it.csi.pbandi.pbservizit.pbandisrv.util.Constants.DESC_TIPO_LINEA_NORMATIVA;
				String descAsse = it.csi.pbandi.pbservizit.pbandisrv.util.Constants.DESC_TIPO_LINEA_ASSE;
				String descMisura = it.csi.pbandi.pbservizit.pbandisrv.util.Constants.DESC_TIPO_LINEA_MISURA;
				String descLinea = it.csi.pbandi.pbservizit.pbandisrv.util.Constants.DESC_TIPO_LINEA_LINEA;
	...
	private ArrayList<String> ruoliEnteCompetenzaObbligatori = new ArrayList<String>() {
		{
			add(Constants.RUOLO_ENTE_COMPETENZA_DESTINATARIO);
			add(Constants.RUOLO_ENTE_COMPETENZA_PROGRAMMATORE);
			add(Constants.RUOLO_ENTE_COMPETENZA_RESPONSABILE);
	...
	public boolean isRuoliEnteObbligatoriAssociati(Long idBandoLinea, ArrayList<EnteDiCompetenzaRuoloAssociatoDTO> entiAssociati)
			throws Exception {
		ArrayList<String> tempRuoliObbligatori = new ArrayList<String>();
		tempRuoliObbligatori.addAll(ruoliEnteCompetenzaObbligatori);
		for (EnteDiCompetenzaRuoloAssociatoDTO enteDiCompetenza : entiAssociati) {
			if(tempRuoliObbligatori.contains(enteDiCompetenza.getRuolo())) {
				tempRuoliObbligatori.remove(enteDiCompetenza.getRuolo());
			}
		}
		return tempRuoliObbligatori.size() == 0;
	}
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoAssociazione associaSportelloBando(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.GestioneBackOfficeEsitoGenerico eliminaSportelloBandoAssociato(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.SportelloBandoDTO[] findSportelliBandoAssociati(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.PremialitaDTO[] findPremialita(
			Long idUtente, String identitaDigitale)
	throws CSIException, SystemException, UnrecoverableException,GestioneBackOfficeException {
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoAssociazione inserisciPremialita(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.GestioneBackOfficeEsitoGenerico eliminaPremialita(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.PremialitaDTO[] findPremialitaAssociate(
			Long idUtente, String identitaDigitale, Long progrBandoLinea)
	throws CSIException, SystemException, UnrecoverableException,GestioneBackOfficeException {
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoAssociazione associaPremialita(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.GestioneBackOfficeEsitoGenerico eliminaPremialitaAssociata(
			Long idUtente, String identitaDigitale, Long idPremialita, Long progrBandoLinea)
	throws CSIException, SystemException, UnrecoverableException,GestioneBackOfficeException {
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoAssociazione inserisciAllegato(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.GestioneBackOfficeEsitoGenerico eliminaAllegato(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.AllegatoAssociatoDTO[] findAllegatiAssociati(
			Long idUtente, String identitaDigitale, Long progrBandoLinea)
	throws CSIException, SystemException, UnrecoverableException,GestioneBackOfficeException {
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoAssociazione associaAllegato(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.GestioneBackOfficeEsitoGenerico eliminaAllegatoAssociato(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoAssociazione inserisciDettTipolAiuti(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.GestioneBackOfficeEsitoGenerico eliminaDettTipolAiuti(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.DettTipolAiutiAssociatoDTO[] findDettTipolAiutiAssociati(
			Long idUtente, String identitaDigitale, Long progrBandoLinea)
	throws CSIException, SystemException, UnrecoverableException,GestioneBackOfficeException {
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoAssociazione associaDettTipolAiuti(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.GestioneBackOfficeEsitoGenerico eliminaDettTipolAiutiAssociato(
			Long idUtente, String identitaDigitale, Long idDettTipolAiuti, Long progrBandoLinea)
	throws CSIException, SystemException, UnrecoverableException,GestioneBackOfficeException {
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.DettTipolAiutiAssociatoDTO[] findDettTipolAiutiByProgrBandoLinea(
			Long idUtente, String identitaDigitale, Long progrBandoLinea)
	throws CSIException, SystemException, UnrecoverableException,GestioneBackOfficeException {
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoAssociazione inserisciCampoIntervento(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.GestioneBackOfficeEsitoGenerico eliminaCampoIntervento(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.TipolInterventoDTO[] findTipolInterventi(Long idUtente,String identitaDigitale)
	throws CSIException, SystemException, UnrecoverableException,GestioneBackOfficeException {
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoAssociazione inserisciTipolInterventi(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.GestioneBackOfficeEsitoGenerico eliminaTipolInterventi(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.GestioneBackOfficeEsitoGenerico eliminaDettTipolInterventi(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.DettTipolInterventoDTO[] findDettTipolInterventi(Long idUtente,String identitaDigitale)
	throws CSIException, SystemException, UnrecoverableException,GestioneBackOfficeException {
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoAssociazione inserisciDettTipolInterventi(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.InterventoAssociatoDTO[] findInterventiAssociati(
			Long idUtente, String identitaDigitale, Long idBando)
	throws CSIException, SystemException, UnrecoverableException,GestioneBackOfficeException {
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoAssociazione associaIntervento(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.GestioneBackOfficeEsitoGenerico eliminaInterventoAssociato(
			Long idUtente, String identitaDigitale,  Long idTipolIntervento, Long idBando)
	throws CSIException, SystemException, UnrecoverableException,GestioneBackOfficeException {
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.EsitoAssociazione creaMacroVoceDiSpesa(
	...
	public it.csi.pbandi.pbservizit.pbandisrv.dto.gestionebackoffice.GestioneBackOfficeEsitoGenerico gestisciAtecoInclusiEsclusi(
			Long idUtente, String identitaDigitale, Long idBando,
		...
		if(datiBeneficiarioProgetto.getIdSoggetto()==null){
			 ...
			 BigDecimal idTipoSoggettoPersonaGiuridica= new BigDecimal(
						decodificheManager.findDecodifica(
										GestioneDatiDiDominioSrv.TIPO_SOGGETTO,
										it.csi.pbandi.pbservizit.pbandisrv.util.Constants.DESCRIZIONE_BREVE_TIPO_SOGG_PERSONA_GIURIDICA)
								.getId());
	...
	public EsitoSalvaUtente inserisciTabellaUtente(Long idUtente,
		...
		// Jira PBANDI-2778: inizio.
		if (soggettoVO != null) {
			String cf = soggettoVO.getCodiceFiscaleSoggetto();
			if (!StringUtil.isEmpty(cf)) {
				PbandiTUtenteVO vo = new PbandiTUtenteVO();
				vo.setCodiceUtente(cf);
				List<PbandiTUtenteVO> lista = genericDAO.findListWhere(vo);
				if (lista != null && lista.size() > 0) {
					logger.info("inserisciTabellaUtente(): Esiste già un altro record con lo stesso codice fiscale: esco senza inserire.");
					esito.setEsito(Boolean.TRUE);					
					return esito;
				}
			}
		}
		// Jira PBANDI-2778: fine.
		...
		logger.info("inserisciTabellaUtente(): inserito nuovo record con id = "+newUtente.getIdUtente());
	...
	@Deprecated
	@Override
	public GestioneBackOfficeEsitoGenerico verificaParolaChiaveActa(Long idUtente, String identitaDigitale,
			Long progrBandoLineaEnteComp)
			throws CSIException, SystemException, UnrecoverableException, GestioneBackOfficeException {
		// TODO Auto-generated method stub
		
		//PK spostato nelle singole componenti: pbweb e pbwebbo
		
		throw new CSIException("NON USARE");
	}
	...
	public boolean bandoIsEnteCompetenzaFinpiemonte(Long progBandoLineaIntervento) throws Exception { 
		...
		boolean result = pbandiBackOfficeDAOImpl.bandoIsEnteCompetenzaFinpiemonte(progBandoLineaIntervento);
	...
	public Boolean isBandoSif(Long progBandoLineaIntervento) throws Exception { 
		...
		Boolean result = pbandiBackOfficeDAOImpl.isBandoSif(progBandoLineaIntervento);
	...
	public Boolean isBandoSiffino(Long progBandoLineaIntervento, Long idBando) throws Exception {
		...
		Boolean result = pbandiBackOfficeDAOImpl.isBandoSiffino(progBandoLineaIntervento, idBando);
	...
	public Long getProgrBandoLineaByIdProgetto(Long idProgetto) throws Exception {
		...
		Long result = pbandiBackOfficeDAOImpl.getProgrBandoLineaByIdProgetto(idProgetto);
