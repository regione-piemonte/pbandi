...
////{PROTECTED REGION ID(R-1600210534) ENABLED START////}
/**
...
public class BeneficiarioDTO implements java.io.Serializable {
	 ...
	 * @generated
	 */
	private java.lang.Boolean anagraficaAggiornabile = null;

	/**
	 * @generated
	 */
	public void setAnagraficaAggiornabile(java.lang.Boolean val) {
		anagraficaAggiornabile = val;
	}

	////{PROTECTED REGION ID(R1928598267) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo anagraficaAggiornabile. 
	 * Descrivere:
	 * <ul>
	 ...
	 */
	////{PROTECTED REGION END////}
	public java.lang.Boolean getAnagraficaAggiornabile() {
		return anagraficaAggiornabile;
	}
	...
	////{PROTECTED REGION ID(R872531264) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1564396838) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1599614452) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1360840423) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R976046331) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R714845233) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R251108807) ENABLED START*/
	/// inserire qui eventuali ridefinizioni di toString, hashCode, equals
	@Override
	public String toString() {
		return "BeneficiarioDTO [anagraficaAggiornabile=" + anagraficaAggiornabile + ", codiceFiscaleSoggetto="
				+ codiceFiscaleSoggetto + ", denominazioneBeneficiario=" + denominazioneBeneficiario
				+ ", idEnteGiuridico=" + idEnteGiuridico + ", idProgetto=" + idProgetto + ", idSoggetto=" + idSoggetto
