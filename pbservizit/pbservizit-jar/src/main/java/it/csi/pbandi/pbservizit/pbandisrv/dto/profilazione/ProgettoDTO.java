...
////{PROTECTED REGION ID(R894513806) ENABLED START////}
/**
...
public class ProgettoDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1428549363) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1520078216) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1811178256) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1671151421) ENABLED START*/
