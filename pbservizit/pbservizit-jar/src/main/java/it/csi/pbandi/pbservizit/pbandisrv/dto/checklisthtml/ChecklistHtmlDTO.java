...
package it.csi.pbandi.pbservizit.pbandisrv.dto.checklisthtml;
...
public class ChecklistHtmlDTO implements java.io.Serializable {
	 ...
	 * @generated
	 */
	private it.csi.pbandi.pbservizit.pbandisrv.dto.checklisthtml.EsitoChecklistAffidamentoDTO esitoIntermedio = null;

	/**
	 * @generated
	 */
	public void setEsitoIntermedio(
			it.csi.pbandi.pbservizit.pbandisrv.dto.checklisthtml.EsitoChecklistAffidamentoDTO val) {
		esitoIntermedio = val;
	}
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbservizit.pbandisrv.dto.checklisthtml.EsitoChecklistAffidamentoDTO getEsitoIntermedio() {
	 ...
	 * @generated
	 */
	private it.csi.pbandi.pbservizit.pbandisrv.dto.checklisthtml.EsitoChecklistAffidamentoDTO esitoDefinitivo = null;
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbservizit.pbandisrv.dto.checklisthtml.EsitoChecklistAffidamentoDTO getEsitoDefinitivo() {
	 ...
	 * @generated
	 */
	private it.csi.pbandi.pbservizit.pbandisrv.dto.checklisthtml.FileDTO[] allegati = null;

	/**
	 * @generated
	 */
	public void setAllegati(
			it.csi.pbandi.pbservizit.pbandisrv.dto.checklisthtml.FileDTO[] val) {
		allegati = val;
	}
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbservizit.pbandisrv.dto.checklisthtml.FileDTO[] getAllegati() {
		return allegati;
	}

	

	/*PROTECTED REGION ID(R-296803340) ENABLED START*/
	/// inserire qui eventuali ridefinizioni di toString, hashCode, equals
	
	@Override
	public String toString() {
		String str = "ChecklistHtmlDTO [codStatoTipoDocIndex=" + codStatoTipoDocIndex + ", contentHtml=" + contentHtml
				+ ", idChecklist=" + idChecklist + ", idDocumentoIndex=" + idDocumentoIndex + ", idProgetto="
				+ idProgetto + ", soggettoControllore=" + soggettoControllore + ", bytesVerbale=x, "
				+ "esitoIntermedio=x, esitoDefinitivo=x, nomeFile=" + nomeFile;
		
		if(allegati!=null) {
			str += ", allegati.length="+allegati.length+"]";
		}else {
			str += ", allegati=null]";
		}
		return  str;
