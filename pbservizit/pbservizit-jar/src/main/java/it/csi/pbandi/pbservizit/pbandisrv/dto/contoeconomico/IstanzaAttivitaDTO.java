...
////{PROTECTED REGION ID(R308132337) ENABLED START////}
/**
...
public class IstanzaAttivitaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-237564212) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-187919168) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-543474992) ENABLED START*/
