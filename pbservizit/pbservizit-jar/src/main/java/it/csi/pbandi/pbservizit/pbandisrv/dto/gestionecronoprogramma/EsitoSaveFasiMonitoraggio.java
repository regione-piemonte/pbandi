...
////{PROTECTED REGION ID(R2104059410) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoSaveFasiMonitoraggio.
 * Consigli:
 * <ul>
...
public class EsitoSaveFasiMonitoraggio implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R996537566) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1712835182) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1191041807) ENABLED START*/
