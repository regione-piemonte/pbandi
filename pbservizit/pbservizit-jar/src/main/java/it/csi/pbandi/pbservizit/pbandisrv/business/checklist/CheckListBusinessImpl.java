...
package it.csi.pbandi.pbservizit.pbandisrv.business.checklist;
...
import it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.CheckListDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.CheckListInLocoDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.DichiarazioneDiSpesaChecklistDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.EsitoEliminaCheckListDTO;
...
import it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.FiltroRicercaCheckListDTO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.DocumentoIndexChecklistVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.interfacecsi.checklist.CheckListSrv;
...
public class CheckListBusinessImpl extends BusinessImpl implements CheckListSrv {
	...
	public EsitoGetModuloCheckListDTO getModuloCheckListInLoco(Long idUtente,
		...
		EsitoGetModuloCheckListDTO esitoGetModulo = new EsitoGetModuloCheckListDTO();
		try {
			it.csi.pbandi.pbservizit.pbandisrv.dto.manager.CheckListInLocoDTO checkListInLocoDTO = new it.csi.pbandi.pbservizit.pbandisrv.dto.manager.CheckListInLocoDTO();
		...
		try {
			EsitoSalvaModuloCheckListDTO esitoSalvaModuloManager = checkListManager
					.salvaChecklistValidazione(idUtente, idProgetto,
							...
							idDichiarazione);
			esitoSalvaModulo = new it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.EsitoSalvaModuloCheckListDTO();
...
//			}
	...
	public boolean salvaDocumentoSuDB(Long idUtente, String identitaDigitale,
		...
		checkListInLocoDTO
				.setBytesVerbaleAllegatoPdf(bytesAllegatoChecklistInLoco);
...

	{
		...
		logger.info("\n\n#############\ngetFilesAssociatedVerbaleChecklist ,codTipoDocIndex:"+codTipoDocIndex+", idChecklist "+idChecklist);
...

	{
		...
		return getFilesAssociatedVerbaleChecklist(idUtente,identitaDigitale,codTipoDocIndex,idTarget);
	}
