...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.AttivitaAtecoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoLineaDaCuiDuplicareModelliVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoLineaTemaPrioritarioAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoLineaTipoPeriodoAssociatoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.ClassificazioneRaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.DeliberaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.EnteDiCompetenzaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.PeriodoProgettoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.PrioritaQsnLineaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.ProgettoSoggettiPrivatiVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.UtentePersonaFisicaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionebackoffice.ModelloBandoLineaVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiCSchemaFattElettVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDClassRevocaIrregVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDClassificazioneMetVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDComuneVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDDimensioneTerritorVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDGrandeProgettoVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDIntesaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDLivelloIstituzioneVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDPrioritaQsnVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDProgettoComplessoVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDSettoreAttivitaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDSettoreCipeVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDSettoreCptVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDStrumentoAttuativoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTemaPrioritarioVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipoAffidamentoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipoAiutoVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipoLocalizzazioneVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipoOperazioneVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipoProceduraOrigVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipoStrumentoProgrVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipolVoceDiSpesaVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipologiaAggiudicazVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipologiaAttivazioneVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipologiaCipeVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiDTipologieVariantiVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTProcessoVO;
...
public class DecodificheManager {
	...
	static {
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaTipoOperazioneVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaTipologiaAttivVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaTipoIndicatoreVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaTipoLocalVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaLivelloIstituzVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaProgComplessoVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaModAgevolVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaTipoAiutoVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaTemaPriorVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaIndicatoreQsnVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaClassifMetVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaRuoloEnteCompVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaStrumentoAttVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaDimensioneTerVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaTipologiaAggVO");
		...
		TABELLE_R_DECODIFICA.put(
				...
				new HashMap<String, String>() {
					{ 
						put(NOME_CLASSE_PROPERTY_NAME, "it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiRLineaSettoreAttVO");
	...
	private DecodificaDTO[] findDecodificheMultiProgr(String chiave, boolean checkSelezionabile, Long idLineaDiIntervento) throws Exception {
		Class<GenericVO> voClass = (Class<GenericVO>) GenericVO.class.getClassLoader().loadClass(chiave);
		logger.debug("voClass="+voClass);
	...
	private <T extends GenericVO> DecodificaDTO[] findDecodificheFiltratoMultiProgr(
			...
			throws ClassNotFoundException, InstantiationException,
			IllegalAccessException, Exception {
		Class<T> voClass = (Class<T>) GenericVO.class.getClassLoader().loadClass(chiave);
		T vo = voClass.newInstance();
		beanUtil.setPropertyValueByName(vo, nomeCampo, valore);
