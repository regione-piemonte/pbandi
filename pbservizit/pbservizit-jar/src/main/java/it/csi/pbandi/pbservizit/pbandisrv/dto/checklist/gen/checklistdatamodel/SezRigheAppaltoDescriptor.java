...
public class SezRigheAppaltoDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SezRigheAppaltoDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezRigheAppaltoDescriptor()
    ...
    {
        return it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezRigheAppalto.class;
