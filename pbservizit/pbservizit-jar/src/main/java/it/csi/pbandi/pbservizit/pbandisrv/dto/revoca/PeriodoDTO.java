...
////{PROTECTED REGION ID(R1114825270) ENABLED START////}
/**
...
public class PeriodoDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1509172157) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1583111276) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1569108075) ENABLED START*/
