...
////{PROTECTED REGION ID(R1392981138) ENABLED START////}
/**
...
public class MessaggioDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R327174285) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1707669656) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-2056656881) ENABLED START*/
