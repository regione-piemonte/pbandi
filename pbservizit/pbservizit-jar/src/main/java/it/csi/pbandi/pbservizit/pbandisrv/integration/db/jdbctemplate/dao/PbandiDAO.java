...
//public abstract class PbandiDAO {
...
//					array = new oracle.sql.ARRAY(arrayDescriptor, vendorConnection.getUnderlyingConnection(), documenti);
					...
					oc = ocw.unwrap();
					array = (oracle.sql.ARRAY) oc.createArrayOf("T_NUMBER_ARRAY", documenti);
...
//			}
    ...
    */
	...
	public <T extends it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.GenericVO> void updateClob(
		...
		if (vo.isPKValid()) {
			...
			getLogger().debug("[PbandiDAO::updateClob] lobHandler="+lobHandler);
