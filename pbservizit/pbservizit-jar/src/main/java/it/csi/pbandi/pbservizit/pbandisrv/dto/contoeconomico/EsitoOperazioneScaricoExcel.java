...
////{PROTECTED REGION ID(R-447107195) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoOperazioneScaricoExcel.
 * Consigli:
 * <ul>
...
public class EsitoOperazioneScaricoExcel implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R320168145) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R317586438) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1643233606) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1133606490) ENABLED START*/
