...
////{PROTECTED REGION ID(R-1087358604) ENABLED START////}
/**
 * Inserire qui la documentazione della classe TipoDocumentoIndexDTO.
 * Consigli:
 * <ul>
...
public class TipoDocumentoIndexDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-310134079) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-115323789) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-277737491) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-26751507) ENABLED START*/
