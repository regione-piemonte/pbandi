...
public class PbandiRBandoLineaEnteCompVO extends GenericVO {
	...
	public PbandiRBandoLineaEnteCompVO (BigDecimal idRuoloEnteCompetenza, BigDecimal progrBandoLineaIntervento, Date dtFineValidita, BigDecimal idEnteCompetenza, BigDecimal idUtenteAgg, BigDecimal idUtenteIns, BigDecimal progrBandoLineaEnteComp, BigDecimal conservazioneCorrente, BigDecimal conservazioneGenerale) {
	...
	public String toString() {
	    ...
	    temp = DataFilter.removeNull( conservazioneGenerale);
	    if (!DataFilter.isEmpty(temp)) sb.append(" conservazioneGenerale: " + temp + "\t\n");
	    
	    temp = DataFilter.removeNull( conservazioneCorrente);
	    if (!DataFilter.isEmpty(temp)) sb.append(" conservazioneCorrente: " + temp + "\t\n");
