...
public class ArchivioFileVO extends GenericVO {
	...
	public String toString() {
		return "ArchivioFileVO{" +
				"dtInserimentoFile=" + dtInserimentoFile +
				", dtInserimentoFolder=" + dtInserimentoFolder +
				", dtAggiornamentoFile=" + dtAggiornamentoFile +
				", dtAggiornamentoFolder=" + dtAggiornamentoFolder +
				", entitiesAssociated=" + entitiesAssociated +
				", idDocumentoIndex=" + idDocumentoIndex +
				", idEntita=" + idEntita +
				", idFile=" + idFile +
				", idFolder=" + idFolder +
				", idPadre=" + idPadre +
				...
				", flagEntita='" + flagEntita + '\'' +
				", descStatoTipoDocIndex='" + descStatoTipoDocIndex + '\'' +
				", idProgettoFolder=" + idProgettoFolder +
				'}';
	}
}
