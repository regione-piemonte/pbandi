...
public class PbandiRBandoModalitaAgevolVO extends GenericVO {
  	...
  	private BigDecimal periodoStabilita;
  	
  	private String flagLiquidazione;
  	
  	private BigDecimal minimoImportoAgevolato;
  	
  	private BigDecimal percentualeImportoDaErogare;
	...
	public BigDecimal getPeriodoStabilita() {
		return periodoStabilita;
	}

	public void setPeriodoStabilita(BigDecimal periodoStabilita) {
		this.periodoStabilita = periodoStabilita;
	}	
	

	public BigDecimal getPercentualeImportoDaErogare() {
		return percentualeImportoDaErogare;
	}

	public void setPercentualeImportoDaErogare(BigDecimal percentualeImportoDaErogare) {
	...
	public String toString() {
	    ...
	    temp = DataFilter.removeNull( periodoStabilita);
	    if (!DataFilter.isEmpty(temp)) sb.append(" periodoStabilita: " + temp + "\t\n");	 
