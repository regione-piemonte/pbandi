...
////{PROTECTED REGION ID(R-34272971) ENABLED START////}
/**
...
public class MessaggioDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1423416592) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1099345773) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1029732613) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R816517196) ENABLED START*/
