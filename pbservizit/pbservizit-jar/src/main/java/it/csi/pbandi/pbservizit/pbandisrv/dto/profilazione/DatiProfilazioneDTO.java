...
public class DatiProfilazioneDTO implements java.io.Serializable {
	 ...
	 * @generated
	 */
	private it.csi.pbandi.pbservizit.pbandisrv.dto.profilazione.AzioneComponenteGUI[] _azioniComponentiGUI = null;

	/**
	 * @generated
	 */
	public void setAzioniComponentiGUI(
			it.csi.pbandi.pbservizit.pbandisrv.dto.profilazione.AzioneComponenteGUI[] val) {
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbservizit.pbandisrv.dto.profilazione.AzioneComponenteGUI[] getAzioniComponentiGUI() {
