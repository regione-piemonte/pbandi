...
package it.csi.pbandi.pbservizit.pbandisrv.exception.erogazione;

import it.csi.csi.wrapper.SystemException;
import it.csi.csi.wrapper.UserException;
import it.csi.csi.wrapper.UnrecoverableException;

////{PROTECTED REGION ID(R-1439714210) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione ErogazioneException.
 * Consigli:
 * <ul>
