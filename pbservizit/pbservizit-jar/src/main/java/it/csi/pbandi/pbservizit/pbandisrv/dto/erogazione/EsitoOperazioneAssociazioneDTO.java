...
////{PROTECTED REGION ID(R1135799729) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoOperazioneAssociazioneDTO.
 * Consigli:
 * <ul>
...
public class EsitoOperazioneAssociazioneDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-605544923) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R876326397) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-496827376) ENABLED START*/
