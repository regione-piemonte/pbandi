...
public class Messaggio  extends it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.documentiService.MessaggioBase  implements java.io.Serializable {
    public Messaggio() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://siac.csi.it/integ/data/1.0", "messaggio"));
    }
