...
public class PbandiDLineaDiInterventoVO extends GenericVO {
  	...
  	private String flagTrasferimenti;
	...
	public PbandiDLineaDiInterventoVO (String codIgrueT13T14, BigDecimal idProcesso, Date dtInizioValidita, BigDecimal idTipoStrumentoProgr, BigDecimal numDelibera, BigDecimal idStrumentoAttuativo, BigDecimal idLineaDiInterventoPadre, BigDecimal annoDelibera, Date dtFineValidita, BigDecimal idTipoLineaIntervento, BigDecimal idLineaDiIntervento, String codLivGerarchico, String descBreveLinea, String descLinea, String flagCampionRilev, String flagTrasferimenti) {
		...
		this.flagTrasferimenti = flagTrasferimenti;
	}
	...
	public String getFlagTrasferimenti() {
		return flagTrasferimenti;
	}

	public void setFlagTrasferimenti(String flagTrasferimenti) {
		this.flagTrasferimenti = flagTrasferimenti;
	}
	...
	public String toString() {
	    ...
	    temp = DataFilter.removeNull( flagTrasferimenti);
	    if (!DataFilter.isEmpty(temp)) sb.append(" flagTrasferimenti: " + temp + "\t\n");
