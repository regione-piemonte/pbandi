...
////{PROTECTED REGION ID(R1743421452) ENABLED START////}
/**
 * Inserire qui la documentazione della classe FiltroTipoDocumentoIndexDTO.
 * Consigli:
 * <ul>
...
public class FiltroTipoDocumentoIndexDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-808376083) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1149704459) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1118439632) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1987196949) ENABLED START*/
