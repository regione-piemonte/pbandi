...
////{PROTECTED REGION ID(R558166321) ENABLED START////}
/**
 * Inserire qui la documentazione della classe FornitoreAppaltoDTO.
 * Consigli:
 * <ul>
...
public class FornitoreAppaltoDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1174072198) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R803877123) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-2000963109) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-856173220) ENABLED START////}
	/**
	 ...
	 * @generated
	 */
	private java.lang.String descFornitore = null;

	/**
	 * @generated
	 */
	public void setDescFornitore(java.lang.String val) {
		descFornitore = val;
	}

	////{PROTECTED REGION ID(R-2005373168) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo descFornitore. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	 ...
	 */
	////{PROTECTED REGION END////}
	public java.lang.String getDescFornitore() {
	...
	////{PROTECTED REGION ID(R1776505785) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R226267194) ENABLED START*/
