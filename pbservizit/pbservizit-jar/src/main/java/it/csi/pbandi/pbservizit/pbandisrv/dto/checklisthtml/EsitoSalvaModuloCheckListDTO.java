...
////{PROTECTED REGION ID(R1295781505) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoSalvaModuloCheckListDTO.
 * Consigli:
 * <ul>
...
public class EsitoSalvaModuloCheckListDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1908101409) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1577254741) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R2031799910) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1948803911) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R846180602) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-91227734) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-95416704) ENABLED START*/
