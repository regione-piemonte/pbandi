...
////{PROTECTED REGION ID(R-306960268) ENABLED START////}
/**
 * Inserire qui la documentazione della classe IdDescBreveDescEstesaDTO.
 * Consigli:
 * <ul>
...
public class IdDescBreveDescEstesaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1363929231) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1098516097) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R392981394) ENABLED START////}
	/**
	...
	public String toString() {
		...
		builder.append("IdDescBreveDescEstesaDTO [id=");
		builder.append(id);
		builder.append(", descBreve=");
		builder.append(descBreve);
		builder.append(", descEstesa=");
		builder.append(descEstesa);
		builder.append("]");
	...
	/*PROTECTED REGION ID(R-837034217) ENABLED START*/
