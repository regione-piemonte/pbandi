...
////{PROTECTED REGION ID(R825400366) ENABLED START////}
/**
 * Inserire qui la documentazione della classe AppaltoInfoDTO.
 * Consigli:
 * <ul>
...
public class AppaltoInfoDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1159863166) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1618653215) ENABLED START////}
	/**
	 ...
	 * @generated
	 */
	private java.lang.String oggetto = null;
	...
	////{PROTECTED REGION ID(R-103944821) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo oggetto. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	...
	////{PROTECTED REGION ID(R2132541720) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1070528038) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-652326093) ENABLED START*/
