...
////{PROTECTED REGION ID(R-793422389) ENABLED START////}
/**
...
public class IstanzaAttivitaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R2025266214) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-430068186) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1268599562) ENABLED START*/
