...
package it.csi.pbandi.pbservizit.pbandisrv.exception.impegnobilancio;

import it.csi.csi.wrapper.SystemException;
import it.csi.csi.wrapper.UserException;
import it.csi.csi.wrapper.UnrecoverableException;

////{PROTECTED REGION ID(R-1939506261) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione ImpegnoBilancioException.
 * Consigli:
 * <ul>
...
public class ImpegnoBilancioException extends UserException

{
	 ...
	 * @generated
	 */
	public ImpegnoBilancioException(String msg, String nestedExcClassName,
	 ...
	 * @generated
	 */
	public ImpegnoBilancioException(String msg, Throwable nested) {
		super(msg, nested);
	}
	 ...
	 * @generated
	 */
	public ImpegnoBilancioException(String msg) {
		super(msg);
	}
}
