...
package it.csi.pbandi.pbservizit.filter;
...
public class XSRFProtectionFilter implements Filter {
	 ...
	 */
	private static final String XSRF_HEADER_NAME = "X-XSRF-TOKEN-SERV";

	/*
	 * nome del cookie XSRF
	 */
	private static final String XSRF_COOKIE_NAME = "XSRF-TOKEN-SERV";

	/**
	 * nome dell'attributo di sessione che mantiene il token XSRF 
	 */
	private static final String XSRF_INTERNAL_TOKEN_NAME = "XSRF_SESSION_TOKEN-SERV";
	...
	private boolean isRestRequest(HttpServletRequest hreq) {
		return hreq.getRequestURI() != null && hreq.getRequestURI().contains("api");
	}
