...
////{PROTECTED REGION ID(R-1305897543) ENABLED START////}
/**
 * Inserire qui la documentazione della classe ParamInviaInVerificaDTO.
 * Consigli:
 * <ul>
...
public class ParamInviaInVerificaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1949061549) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1832696440) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R283235043) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R864511504) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1893534683) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1207397491) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-630449742) ENABLED START*/
