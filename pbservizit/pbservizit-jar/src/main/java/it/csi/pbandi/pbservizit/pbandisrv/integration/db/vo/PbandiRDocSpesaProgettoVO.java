...
public class PbandiRDocSpesaProgettoVO extends GenericVO {
	...
	public String toString() {
	    ...
	    if (!DataFilter.isEmpty(temp)) sb.append(" task: " + temp + "\t\n");
	    ...
	    if (!DataFilter.isEmpty(temp)) sb.append(" idStatoDocumentoSpesaValid: " + temp + "\t\n");
	    
	    temp = DataFilter.removeNull( noteValidazione);
	    if (!DataFilter.isEmpty(temp)) sb.append(" noteValidazione: " + temp + "\t\n");
	    ...
	    if (!DataFilter.isEmpty(temp)) sb.append(" importoRendicontazione: " + temp + "\t\n");
	    
	    temp = DataFilter.removeNull( tipoInvio);
	    if (!DataFilter.isEmpty(temp)) sb.append(" tipoInvio: " + temp + "\t\n");
