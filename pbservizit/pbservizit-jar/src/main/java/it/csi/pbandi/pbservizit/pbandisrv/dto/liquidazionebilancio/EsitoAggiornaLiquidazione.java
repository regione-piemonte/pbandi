...
////{PROTECTED REGION ID(R133372221) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoAggiornaLiquidazione.
 * Consigli:
 * <ul>
...
public class EsitoAggiornaLiquidazione implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R2101515672) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R250694169) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1482590166) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-519868157) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1354810172) ENABLED START*/
