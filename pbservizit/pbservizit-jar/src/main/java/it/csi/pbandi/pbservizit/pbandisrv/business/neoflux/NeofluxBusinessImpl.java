...
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.MiniApp.PBANDIWEBEROGSRV;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.MiniApp.PBANDIWEBFINSRV;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.MiniApp.PBANDIWEBRCESRV;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.MiniApp.PBANDIWEBSRV;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.CARICAM_INDIC_AVVIO;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.CARICAM_INDIC_PROG;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.CHIUSURA_PROGETTO;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.CHIUS_PROG_RINUNCIA;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.CHIUS_UFF_PROG;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.COMUNIC_FINE_PROG;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.COMUNIC_RINUNCIA;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.CONSULTA_LIQUID;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.CRONOPROGRAMMA;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.CRONOPROG_AVVIO;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.DATI_PROG;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.DICH_DI_SPESA;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.DICH_SPESA_INTEGRATIVA;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.EROGAZIONE;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.GEST_APPALTI;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.GEST_CHECKLIST;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.GEST_FIDEIUSSIONI;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.GEST_SPESA_VALID;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.LIQUIDAZIONE;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.MOD_EROG;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.MOD_RECUPERO;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.MOD_REVOCA;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.PROP_RIM_CE;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.QUADRO_PREVISIO;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.RECUPERO;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.RET_CRONOPROG;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.RET_INDIC_PROG;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.REVOCA;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.RICH_CE_DOM;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.RICH_EROG_CALC_CAU;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.RILEV_IRREGOLAR;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.RIM_CE;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.RIM_CE_ISTR;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.SOPPRESSIONE;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.VALID_DICH_SPESA;
import static it.csi.pbandi.pbservizit.pbandisrv.business.neoflux.Task.VALID_DICH_SPESA_FINALE;
...
import it.csi.pbandi.pbservizit.pbandisrv.dto.neoflux.BandoDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.neoflux.NotificaDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.neoflux.ProgettoDTO;
import it.csi.pbandi.pbservizit.pbandisrv.dto.neoflux.TaskDTO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.BandoVO;
...
*/
	...
	// Simile ad endAttivita(), ma chiude tutti insieme indicatori, cronoprogramma,
	// ds finale e CFP.
	public void endAttivitaDsFinale(Long idUtente, String identitaDigitale, Long idProgetto)
			throws CSIException, SystemException, UnrecoverableException, NeoFluxException {
		...
		int ret = genericDAO.callProcedure().endAttivitaDsFinale(BigDecimal.valueOf(idProgetto),
				BigDecimal.valueOf(idUtente));
