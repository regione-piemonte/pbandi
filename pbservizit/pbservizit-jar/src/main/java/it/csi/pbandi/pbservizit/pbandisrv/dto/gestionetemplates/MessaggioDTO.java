...
////{PROTECTED REGION ID(R1571361153) ENABLED START////}
/**
...
public class MessaggioDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1571655998) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo key. 
	 * Descrivere:
	 * <ul>
	...
	////{PROTECTED REGION ID(R1904682567) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1184396288) ENABLED START*/
