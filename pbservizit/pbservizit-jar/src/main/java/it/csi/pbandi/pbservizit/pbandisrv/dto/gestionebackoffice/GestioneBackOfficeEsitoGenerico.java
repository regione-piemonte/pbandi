...
////{PROTECTED REGION ID(R1666597412) ENABLED START////}
/**
 * Inserire qui la documentazione della classe GestioneBackOfficeEsitoGenerico.
 * Consigli:
 * <ul>
...
public class GestioneBackOfficeEsitoGenerico implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R628529554) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R839961955) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1691873110) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1865986307) ENABLED START*/
