...
////{PROTECTED REGION ID(R1725654978) ENABLED START////}
/**
...
public class MessaggioDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R497060957) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R258986336) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R328599496) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1002729951) ENABLED START*/
