...
public class PbandiErogazioneDAOImpl extends PbandiDAO{
	...
	RowMapper<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.erogazione.FideiussioneVO>{

		public it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.erogazione.FideiussioneVO mapRow(ResultSet rs, int row) throws SQLException {
			
			BeanMapper beanMapper = new BeanMapper();
			FideiussioneVO vo=
				(it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.erogazione.FideiussioneVO) beanMapper.toBean(rs,
						it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.erogazione.FideiussioneVO.class);
			 return vo;
		}
	}
}
