...
import static it.csi.pbandi.pbservizit.pbandisrv.interfacecsi.gestionedocumentidispesa.GestioneDocumentiDiSpesaSrv.*;
...
import it.csi.pbandi.pbservizit.pbandisrv.exception.gestionedocumentidispesa.GestioneDocumentiDiSpesaException;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.dao.GenericDAO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.DocumentoDiSpesaProgettoVO;
...
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.VoceDiSpesaDocumentoVO;
import it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.validazionerendicontazione.DocumentoDiSpesaDichiarazioneTotaleValidatoVO;
...
public class DocumentoDiSpesaManager {
	...
	public static String getCodiceTipoDocumentoDiSpesa(String chiave) {
		System.out.println("getCodiceTipoDocumentoDiSpesa chiave="+chiave);
	...
	public String controlliVociSpesaNoteCreditoDocumento (BigDecimal idDocumentoDiSpesa, BigDecimal idProgetto,boolean isNotaCredito) {
		logger.begin();
		logger.debug("decodificheManager="+decodificheManager);
		String tr = DocumentoDiSpesaManager.getCodiceTipoDocumentoDiSpesa(GestioneDocumentiDiSpesaSrv.TIPO_DOCUMENTO_DI_SPESA_NOTA_DI_CREDITO);
		logger.debug("tr="+tr);
		DecodificaDTO decodifica = decodificheManager.findDecodifica(GestioneDatiDiDominioSrv.TIPO_DOCUMENTO_SPESA,
				DocumentoDiSpesaManager
				.getCodiceTipoDocumentoDiSpesa(GestioneDocumentiDiSpesaSrv.TIPO_DOCUMENTO_DI_SPESA_NOTA_DI_CREDITO));
		logger.debug("decodifica="+decodifica);
