...
////{PROTECTED REGION ID(R1692924377) ENABLED START////}
/**
...
public class CodiceDescrizioneDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1370256684) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1038424534) ENABLED START////}
	/**
	...
	public String toString() {
		...
		builder.append("CodiceDescrizioneDTO [codice=");
	...
	/*PROTECTED REGION ID(R-2024713048) ENABLED START*/
