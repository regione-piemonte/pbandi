...
public class PbandiDocumentiDiSpesaDAOImpl extends PbandiDAO {
	...
	public List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO> findDocumentiDiSpesa(
	...
	public List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO> findDocumentiDiSpesa(
		...
		getLogger().begin();
		java.util.List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO> result = new ArrayList<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO>();
		try {
			/*
	...
	private class DocumentiDiSpesaPerFornitoriRowMapper
			implements
			RowMapper<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionefornitori.DocumentoDiSpesaVO> {

		public it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionefornitori.DocumentoDiSpesaVO mapRow(
				ResultSet rs, int row) throws SQLException {
			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionefornitori.DocumentoDiSpesaVO vo = (it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionefornitori.DocumentoDiSpesaVO) beanMapper
					.toBean(
							rs,
							it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionefornitori.DocumentoDiSpesaVO.class);
			return vo;
		}
	}
	...
	private class DocumentiDiSpesaRowMapper
			implements
			RowMapper<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO> {

		public it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO mapRow(
				ResultSet rs, int row) throws SQLException {

			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO vo = (it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO) beanMapper
					.toBean(
							rs,
							it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO.class);
			return vo;
		}
	}
	...
	private class DocumentiDiSpesaPerDichiarazioneRowMapper
			implements
			RowMapper<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoDiSpesaVO> {

		public it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoDiSpesaVO mapRow(
				ResultSet rs, int row) throws SQLException {

			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoDiSpesaVO vo = (it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoDiSpesaVO) beanMapper
					.toBean(
							rs,
							it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoDiSpesaVO.class);
	...
	public it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO findDettaglioDocumentoDiSpesa(
			Long idDocumentoDiSpesa, Long idProgetto) {
		getLogger().begin();
		it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO result = new it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO();
		try {
	...
	public List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO> findImportiDocumentoDiSpesaProgetto(
			Long idDocumentoDiSpesa, Long idProgetto) {
		getLogger().begin();
		try {
			List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO> result = new ArrayList<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO>();
			MapSqlParameterSource params = new MapSqlParameterSource();
	 ...
	 * @return
	 */
	public List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTQuotaParteDocSpesaVO> findImportiQuotaParteByDocumentoDiSpesaProgetto(
			Long idDocumentoDiSpesa, Long idProgetto, Long idRigoContoEconomico) {
		getLogger().begin();
		try {
			List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTQuotaParteDocSpesaVO> result = new ArrayList<it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTQuotaParteDocSpesaVO>();
			StringBuilder sqlSelect = new StringBuilder(
	...
	public List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionedocumentidispesa.DocumentoDiSpesaVO> findFatturePerFornitore(
	...
	private class QuotaParteDocSpesaRowMapper
			implements
			RowMapper<it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTQuotaParteDocSpesaVO> {

		public it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTQuotaParteDocSpesaVO mapRow(
				ResultSet rs, int row) throws SQLException {

			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTQuotaParteDocSpesaVO vo = (it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTQuotaParteDocSpesaVO) beanMapper
					.toBean(
							rs,
							it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTQuotaParteDocSpesaVO.class);
			return vo;
		}
	}


	public List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTPagamentoVO> findPagamentiAssociatiADocumento(
			Long idDocumentoDiSpesa) {
		getLogger().begin();
		try {
			List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTPagamentoVO> result = null;
			List<StringBuilder> conditionList = new ArrayList<StringBuilder>();
			MapSqlParameterSource params = new MapSqlParameterSource();
	...
	private class PbandiTPagamentoRowMapper
			implements
			RowMapper<it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTPagamentoVO> {

		public it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTPagamentoVO mapRow(
				ResultSet rs, int row) throws SQLException {

			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTPagamentoVO vo = (it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTPagamentoVO) beanMapper
					.toBean(
							rs,
							it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTPagamentoVO.class);
			return vo;
		}
	}
	...
	public List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoDiSpesaVO> findNoteDiCreditoAssociateFattura(
			Long idDocumentoDiSpesa) {
		getLogger().begin();
		try {
			List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoDiSpesaVO> result = new ArrayList<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoDiSpesaVO>();
			StringBuilder sqlSelect = new StringBuilder(
					" SELECT PBANDI_T_DOCUMENTO_DI_SPESA.id_documento_di_spesa as idDocumentoDiSpesa,")
					.append(
	...
	private class PbandiTProgettoVORowMapper
			implements
			RowMapper<it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTProgettoVO> {

		public it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTProgettoVO mapRow(
				ResultSet rs, int row) throws SQLException {

			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTProgettoVO vo = (it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTProgettoVO) beanMapper
					.toBean(
							rs,
							it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiTProgettoVO.class);
			return vo;
		}
	}
	...
	private class PagamentoVoceDiSpesaVORowMapper
			implements
			RowMapper<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoVoceDiSpesaVO> {

		public it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoVoceDiSpesaVO mapRow(
				ResultSet rs, int row) throws SQLException {

			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoVoceDiSpesaVO vo = (it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoVoceDiSpesaVO) beanMapper
					.toBean(
							rs,
							it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoVoceDiSpesaVO.class);
			return vo;
		}
	}
	...
	public List<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoDiSpesaVO> findDocumentiDiSpesaDichiarazione(
	...
	private class DocumentiDiSpesaPerValidazioneRowMapper
			implements
			RowMapper<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.validazionerendicontazione.DocumentoDiSpesaVO> {

		public it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.validazionerendicontazione.DocumentoDiSpesaVO mapRow(
				ResultSet rs, int row) throws SQLException {

			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.validazionerendicontazione.DocumentoDiSpesaVO vo = (it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.validazionerendicontazione.DocumentoDiSpesaVO) beanMapper
					.toBean(
							rs,
							it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.validazionerendicontazione.DocumentoDiSpesaVO.class);
			return vo;
		}
	}
	...
	private class DocumentiDiSpesaPerChiudiValidazioneRowMapper
			implements
			RowMapper<it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.validazionerendicontazione.DocumentoChiudiValidazioneVO> {

		public it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.validazionerendicontazione.DocumentoChiudiValidazioneVO mapRow(
				ResultSet rs, int row) throws SQLException {

			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.validazionerendicontazione.DocumentoChiudiValidazioneVO vo = (it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.validazionerendicontazione.DocumentoChiudiValidazioneVO) beanMapper
					.toBean(
							rs,
							it.csi.pbandi.pbservizit.pbandisrv.integration.db.jdbctemplate.vo.validazionerendicontazione.DocumentoChiudiValidazioneVO.class);
			return vo;
		}
	}
