...
////{PROTECTED REGION ID(R219382660) ENABLED START////}
/**
...
public class FileDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1736192153) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1995321187) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1450632135) ENABLED START*/
