...
public class EsitoProceduraAggiudicazioneDTO implements java.io.Serializable {
	 ...
	 * @generated
	 */
	private it.csi.pbandi.pbservizit.pbandisrv.dto.contoeconomico.MessaggioDTO[] msgs = null;

	/**
	 * @generated
	 */
	public void setMsgs(
			it.csi.pbandi.pbservizit.pbandisrv.dto.contoeconomico.MessaggioDTO[] val) {
		msgs = val;
	}
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbservizit.pbandisrv.dto.contoeconomico.MessaggioDTO[] getMsgs() {
		return msgs;
	}
