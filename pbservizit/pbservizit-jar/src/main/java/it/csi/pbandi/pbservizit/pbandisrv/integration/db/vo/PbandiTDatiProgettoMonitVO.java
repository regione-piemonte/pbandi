...
public class PbandiTDatiProgettoMonitVO extends GenericVO {
	...
	public PbandiTDatiProgettoMonitVO(String flagInvioMonit, BigDecimal idUtenteAgg, String statoFas, String statoFs,
			String flagAltroFondo, String flagLegObiettivo, String flagCardine, String flagGeneratoreEntrate,
			BigDecimal idSoggTitolareCipe, BigDecimal idProgetto, String flagProgettoDiCompletamento,
			String flagExtraPor, String codiceProgettoCipe, BigDecimal idUtenteIns, BigDecimal importoEntrate,
			String flagPPP, String flagStrategico) {
	...
	public boolean isValid() {
		...
		if (isPKValid() && flagInvioMonit != null && statoFas != null && statoFs != null && flagAltroFondo != null
				&& flagLegObiettivo != null && flagCardine != null && flagGeneratoreEntrate != null
				&& flagProgettoDiCompletamento != null && flagExtraPor != null && idUtenteIns != null) {
			isValid = true;
		}
		return isValid;
	}
	...
	public String toString() {
		...
		if (!DataFilter.isEmpty(temp))
			sb.append(" statoFas: " + temp + "\t\n");

		temp = DataFilter.removeNull(statoFs);
		if (!DataFilter.isEmpty(temp))
			sb.append(" statoFs: " + temp + "\t\n");
		...
		if (!DataFilter.isEmpty(temp))
			sb.append(" flagLegObiettivo: " + temp + "\t\n");
		...
		if (!DataFilter.isEmpty(temp))
			sb.append(" idSoggTitolareCipe: " + temp + "\t\n");
		...
		if (!DataFilter.isEmpty(temp))
			sb.append(" flagProgettoDiCompletamento: " + temp + "\t\n");

		temp = DataFilter.removeNull(flagExtraPor);
		if (!DataFilter.isEmpty(temp))
			sb.append(" flagExtraPor: " + temp + "\t\n");

		temp = DataFilter.removeNull(codiceProgettoCipe);
		if (!DataFilter.isEmpty(temp))
			sb.append(" codiceProgettoCipe: " + temp + "\t\n");
