...
public class ChecklistHtmlAnagraficaDTO implements java.io.Serializable {
	...
	public String toString() {
		return "ChecklistHtmlAnagraficaDTO [ammontareTotaleSpesaRendicontata=" + ammontareTotaleSpesaRendicontata
				+ ", ammontareTotaleSpesaValidata=" + ammontareTotaleSpesaValidata + ", assePrioritario="
				+ assePrioritario + ", attoConcessioneContributo=" + attoConcessioneContributo + ", bandoRiferimento="
				+ bandoRiferimento + ", campoIrregolarita=" + campoIrregolarita + ", codiceProgetto=" + codiceProgetto
				+ ", contributoPubblicoConcesso=" + contributoPubblicoConcesso + ", costoTotaleAmmesso="
				+ costoTotaleAmmesso + ", cup=" + cup + ", dataControllo=" + dataControllo
				+ ", denominazioneBeneficiario=" + denominazioneBeneficiario + ", descrizioneProgetto="
				+ descrizioneProgetto + ", firmaResponsabile=" + firmaResponsabile + ", irregolarita=" + irregolarita
				+ ", lineaIntervento=" + lineaIntervento + ", luogoControllo=" + luogoControllo
				+ ", referenteBeneficiario=" + referenteBeneficiario + ", strutturaResponsabile="
				+ strutturaResponsabile + ", titoloProgetto=" + titoloProgetto + ", totaleSpesaRendicontataOperazione="
				+ totaleSpesaRendicontataOperazione + ", titoloBando=" + titoloBando + ", idDichiarazione="
				+ idDichiarazione + ", spesaValidataDS=" + spesaValidataDS + ", spesaRendicontataDS="
				+ spesaRendicontataDS + ", nomeChecklist=" + nomeChecklist + ", oggettoAffidamento="
				+ oggettoAffidamento + ", tipologiaContratto=" + tipologiaContratto + ", idProcesso=" + idProcesso
				+ ", codProcAgg=" + codProcAgg + ", cigProcAgg=" + cigProcAgg + "]";
	}
