...
public class CheckListDataModel implements java.io.Serializable {
     ...
     * Field _vociDiSpesa
     */
    private it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.VociDiSpesa _vociDiSpesa;
     ...
     * Field _controlli
     */
    private it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.Controlli _controlli;
    ...
    } //-- it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.CheckListDataModel()
     ...
     */
    public void addSezioneAppalti(it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti vSezioneAppalti)
        throws java.lang.IndexOutOfBoundsException
    {
        this._sezioneAppaltiList.addElement(vSezioneAppalti);
    } //-- void addSezioneAppalti(it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti) 
     ...
     * given is outside the bounds of the collection
     */
    public void addSezioneAppalti(int index, it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti vSezioneAppalti)
        throws java.lang.IndexOutOfBoundsException
    {
        this._sezioneAppaltiList.add(index, vSezioneAppalti);
    } //-- void addSezioneAppalti(int, it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti) 
     ...
     * it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti
     * elements
     */
     ...
     */
    public it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.Controlli getControlli()
    {
        return this._controlli;
    } //-- it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.Controlli getControlli() 
     ...
     * at the given index
     */
    public it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti getSezioneAppalti(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti) _sezioneAppaltiList.get(index);
    } //-- it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti getSezioneAppalti(int) 
     ...
     */
    public it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti[] getSezioneAppalti()
    {
        int size = this._sezioneAppaltiList.size();
        it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti[] array = new it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti[size];
        for (int index = 0; index < size; index++){
            array[index] = (it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti) _sezioneAppaltiList.get(index);
        }
        
        return array;
    } //-- it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti[] getSezioneAppalti() 
     ...
     */
    public it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.VociDiSpesa getVociDiSpesa()
    {
        return this._vociDiSpesa;
    } //-- it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.VociDiSpesa getVociDiSpesa() 
     ...
     */
    public boolean removeSezioneAppalti(it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti vSezioneAppalti)
    {
        boolean removed = _sezioneAppaltiList.remove(vSezioneAppalti);
        return removed;
    } //-- boolean removeSezioneAppalti(it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti) 
     ...
     */
    public it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti removeSezioneAppaltiAt(int index)
    {
        Object obj = this._sezioneAppaltiList.remove(index);
        return (it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti) obj;
    } //-- it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti removeSezioneAppaltiAt(int) 
     ...
     */
    public void setControlli(it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.Controlli controlli)
    {
        this._controlli = controlli;
    } //-- void setControlli(it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.Controlli) 
     ...
     * given is outside the bounds of the collection
     */
    public void setSezioneAppalti(int index, it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti vSezioneAppalti)
        throws java.lang.IndexOutOfBoundsException
    {
        // check bounds for index
        if (index < 0 || index >= this._sezioneAppaltiList.size()) {
    ...
    } //-- void setSezioneAppalti(int, it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti) 
     ...
     */
    public void setSezioneAppalti(it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti[] vSezioneAppaltiArray)
    {
        //-- copy array
    ...
    } //-- void setSezioneAppalti(it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.SezioneAppalti) 
     ...
     */
    public void setVociDiSpesa(it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.VociDiSpesa vociDiSpesa)
    {
        this._vociDiSpesa = vociDiSpesa;
    } //-- void setVociDiSpesa(it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.VociDiSpesa) 
     ...
     * it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.CheckListDataModel
     */
    public static it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.CheckListDataModel unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.CheckListDataModel) Unmarshaller.unmarshal(it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.CheckListDataModel.class, reader);
    } //-- it.csi.pbandi.pbservizit.pbandisrv.dto.checklist.gen.checklistdatamodel.CheckListDataModel unmarshal(java.io.Reader) 
