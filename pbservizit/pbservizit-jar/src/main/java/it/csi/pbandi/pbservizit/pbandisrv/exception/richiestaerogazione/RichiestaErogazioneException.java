...
package it.csi.pbandi.pbservizit.pbandisrv.exception.richiestaerogazione;

import it.csi.csi.wrapper.SystemException;
import it.csi.csi.wrapper.UserException;
import it.csi.csi.wrapper.UnrecoverableException;

////{PROTECTED REGION ID(R-36801607) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione RichiestaErogazioneException.
 * Consigli:
 * <ul>
...
public class RichiestaErogazioneException extends UserException

{
	 ...
	 * @generated
	 */
	public RichiestaErogazioneException(String msg, String nestedExcClassName,
	 ...
	 * @generated
	 */
	public RichiestaErogazioneException(String msg, Throwable nested) {
		super(msg, nested);
	}
	 ...
	 * @generated
	 */
	public RichiestaErogazioneException(String msg) {
		super(msg);
	}
}
