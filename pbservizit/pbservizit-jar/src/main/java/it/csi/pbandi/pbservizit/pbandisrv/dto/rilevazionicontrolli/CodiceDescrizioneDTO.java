...
////{PROTECTED REGION ID(R-293904797) ENABLED START////}
/**
...
public class CodiceDescrizioneDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1807693258) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1798415604) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1816526328) ENABLED START*/
	/// inserire qui eventuali ridefinizioni di toString, hashCode, equals

	//	@Override
	//	public boolean equals(Object obj) {
	//		return this.codice.equals(((CodiceDescrizioneDTO) obj).getCodice());
	//	}
