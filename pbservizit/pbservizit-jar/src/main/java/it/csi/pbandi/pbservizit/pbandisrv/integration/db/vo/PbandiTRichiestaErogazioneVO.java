...
public class PbandiTRichiestaErogazioneVO extends GenericVO {
  ...
  private String flagBollinoVerificaErogaz;
  ...
  public PbandiTRichiestaErogazioneVO(BigDecimal numeroRichiestaErogazione, BigDecimal idUtenteAgg, BigDecimal idCausaleErogazione, Date dtRaggiungimentoP90, Date dtRichiestaErogazione, BigDecimal importoErogazioneRichiesto, Date dtRaggiungimentoP30, String residenzaDirettoreLavori, String direttoreLavori, BigDecimal idProgetto, Date dtRaggiungimentoP100, Date dtStipulazioneContratti, Date dtInizioLavori, BigDecimal idUtenteIns, BigDecimal idRichiestaErogazione, String flagBollinoVerificaErogaz) {
    ...
    this.idRichiestaErogazione = idRichiestaErogazione;
    this.flagBollinoVerificaErogaz = flagBollinoVerificaErogaz;
  }
  ...
  public String toString() {
    ...
    temp = DataFilter.removeNull(flagBollinoVerificaErogaz);
    if (!DataFilter.isEmpty(temp)) sb.append(" flagBollinoVerificaErogaz: " + temp + "\t\n");
    return sb.toString();
  }
  ...
  public String getFlagBollinoVerificaErogaz() {
    return flagBollinoVerificaErogaz;
  }

  public void setFlagBollinoVerificaErogaz(String flagBollinoVerificaErogaz) {
    this.flagBollinoVerificaErogaz = flagBollinoVerificaErogaz;
  }
}
