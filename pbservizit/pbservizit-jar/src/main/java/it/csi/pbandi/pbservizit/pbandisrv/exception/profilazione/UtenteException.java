...
package it.csi.pbandi.pbservizit.pbandisrv.exception.profilazione;

import it.csi.csi.wrapper.SystemException;
import it.csi.csi.wrapper.UserException;
import it.csi.csi.wrapper.UnrecoverableException;

////{PROTECTED REGION ID(R-1252451351) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione UtenteException.
 * Consigli:
 * <ul>
