...
public class PbandiTRevocaVO extends GenericVO {
	...
	public PbandiTRevocaVO (BigDecimal idUtenteAgg, BigDecimal idMotivoRevoca, String estremi, Date dtAggiornamento, Date dtInserimento, 
			BigDecimal idModalitaAgevolazione, String note, BigDecimal interessiRevoca, BigDecimal idProgetto, Date dtRevoca, Date dtDecorRevoca, BigDecimal idCausaleDisimpegno, 
	...
	public Date getDtDecorRevoca() {
		return dtDecorRevoca;
	}

	public void setDtDecorRevoca(Date dtDecorRevoca) {
		this.dtDecorRevoca = dtDecorRevoca;
	}
	...
	public String toString() {
	    ...
	    temp = DataFilter.removeNull( dtDecorRevoca);
	    if (!DataFilter.isEmpty(temp)) sb.append(" dtDecorRevoca: " + temp + "\t\n");
