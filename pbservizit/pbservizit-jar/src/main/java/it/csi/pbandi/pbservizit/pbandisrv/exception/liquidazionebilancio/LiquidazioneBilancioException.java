...
package it.csi.pbandi.pbservizit.pbandisrv.exception.liquidazionebilancio;

import it.csi.csi.wrapper.SystemException;
import it.csi.csi.wrapper.UserException;
import it.csi.csi.wrapper.UnrecoverableException;

////{PROTECTED REGION ID(R1571200989) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione LiquidazioneBilancioException.
 * Consigli:
 * <ul>
...
public class LiquidazioneBilancioException extends UserException

{
	 ...
	 * @generated
	 */
	public LiquidazioneBilancioException(String msg, String nestedExcClassName,
	 ...
	 * @generated
	 */
	public LiquidazioneBilancioException(String msg, Throwable nested) {
		super(msg, nested);
	}
	 ...
	 * @generated
	 */
	public LiquidazioneBilancioException(String msg) {
		super(msg);
	}
}
