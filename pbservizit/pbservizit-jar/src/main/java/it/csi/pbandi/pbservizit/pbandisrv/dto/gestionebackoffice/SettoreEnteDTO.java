...
////{PROTECTED REGION ID(R-1287531968) ENABLED START////}
/**
 * Inserire qui la documentazione della classe SettoreEnteDTO.
 * Consigli:
 * <ul>
...
public class SettoreEnteDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R988393279) ENABLED START////}
	/**
	 ...
	 * @generated
	 */
	private java.lang.String descBreveSettore = null;

	/**
	 * @generated
	 */
	public void setDescBreveSettore(java.lang.String val) {
		descBreveSettore = val;
	}

	////{PROTECTED REGION ID(R-1354401635) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo descBreveSettore. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	 ...
	 */
	////{PROTECTED REGION END////}
	public java.lang.String getDescBreveSettore() {
	...
	////{PROTECTED REGION ID(R362210115) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R982435823) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-595148717) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1854196725) ENABLED START*/
