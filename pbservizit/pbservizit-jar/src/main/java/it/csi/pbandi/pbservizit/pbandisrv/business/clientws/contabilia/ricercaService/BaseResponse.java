...
public abstract class BaseResponse  implements java.io.Serializable {
    private it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Ente ente;

    private it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Errore[] errori;

    private it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Esito esito;

    private it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Messaggio[] messaggi;
     ...
     * @return ente
     */
    public it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Ente getEnte() {
        return ente;
    }
     ...
     * @param ente
     */
    public void setEnte(it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Ente ente) {
        this.ente = ente;
    }
     ...
     * @return errori
     */
    public it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Errore[] getErrori() {
        return errori;
    }
     ...
     * @param errori
     */
    public void setErrori(it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Errore[] errori) {
        this.errori = errori;
    }

    public it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Errore getErrori(int i) {
        return this.errori[i];
    }

    public void setErrori(int i, it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Errore _value) {
     ...
     * @return esito
     */
    public it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Esito getEsito() {
        return esito;
    }
     ...
     * @param esito
     */
    public void setEsito(it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Esito esito) {
        this.esito = esito;
    }
     ...
     * @return messaggi
     */
    public it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Messaggio[] getMessaggi() {
        return messaggi;
    }
     ...
     * @param messaggi
     */
    public void setMessaggi(it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Messaggio[] messaggi) {
        this.messaggi = messaggi;
    }

    public it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Messaggio getMessaggi(int i) {
        return this.messaggi[i];
    }

    public void setMessaggi(int i, it.csi.pbandi.pbservizit.pbandisrv.business.clientws.contabilia.ricercaService.Messaggio _value) {
