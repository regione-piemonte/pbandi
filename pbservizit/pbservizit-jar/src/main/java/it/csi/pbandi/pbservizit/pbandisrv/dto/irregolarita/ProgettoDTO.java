...
////{PROTECTED REGION ID(R-463642077) ENABLED START////}
/**
...
public class ProgettoDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1596749214) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1947718314) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-392366712) ENABLED START*/
