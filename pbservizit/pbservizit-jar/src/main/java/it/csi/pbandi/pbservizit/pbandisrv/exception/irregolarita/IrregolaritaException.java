...
package it.csi.pbandi.pbservizit.pbandisrv.exception.irregolarita;

import it.csi.csi.wrapper.SystemException;
import it.csi.csi.wrapper.UserException;
import it.csi.csi.wrapper.UnrecoverableException;

////{PROTECTED REGION ID(R-1246008934) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione IrregolaritaException.
 * Consigli:
 * <ul>
...
public class IrregolaritaException extends UserException

{
	 ...
	 * @generated
	 */
	public IrregolaritaException(String msg, String nestedExcClassName,
	 ...
	 * @generated
	 */
	public IrregolaritaException(String msg, Throwable nested) {
		super(msg, nested);
	}
	 ...
	 * @generated
	 */
	public IrregolaritaException(String msg) {
		super(msg);
	}
}
