...
package it.csi.pbandi.pbservizit.pbandisrv.exception.validazionerendicontazione;

import it.csi.csi.wrapper.SystemException;
import it.csi.csi.wrapper.UserException;
import it.csi.csi.wrapper.UnrecoverableException;

////{PROTECTED REGION ID(R-366623015) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione ValidazioneRendicontazioneException.
 * Consigli:
 * <ul>
...
public class ValidazioneRendicontazioneException extends UserException

{
	 ...
	 * @generated
	 */
	public ValidazioneRendicontazioneException(String msg,
	 ...
	 * @generated
	 */
	public ValidazioneRendicontazioneException(String msg, Throwable nested) {
		super(msg, nested);
	}
