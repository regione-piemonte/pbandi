...
////{PROTECTED REGION ID(R2143212798) ENABLED START////}
/**
...
public class IstanzaAttivitaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1956799847) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R724867155) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-2090725981) ENABLED START*/
