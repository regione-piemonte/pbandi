...
////{PROTECTED REGION ID(R-105186081) ENABLED START////}
/**
 * Inserire qui la documentazione della classe AreaScientificaDTO.
 * Consigli:
 * <ul>
...
public class AreaScientificaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1995394618) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-979374732) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-208603587) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R418845836) ENABLED START*/
