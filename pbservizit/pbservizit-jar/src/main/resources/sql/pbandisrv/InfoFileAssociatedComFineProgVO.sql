...
SELECT  
  ...
  COMUNICAZ_FINE_PROG.ID_COMUNICAZ_FINE_PROG  AS ID_COMUNICAZIONE,
  COMUNICAZ_FINE_PROG.DT_COMUNICAZIONE,   
...
JOIN PBANDI_T_FILE_ENTITA FILE_ENTITA ON FILE_ENTITA.ID_FILE=PBANDI_T_FILE.ID_FILE AND 
 FILE_ENTITA.ID_ENTITA=(SELECT ID_ENTITA FROM PBANDI_C_ENTITA WHERE UPPER(NOME_ENTITA)=UPPER('PBANDI_T_COMUNICAZ_FINE_PROG'))
JOIN PBANDI_T_COMUNICAZ_FINE_PROG COMUNICAZ_FINE_PROG
ON (COMUNICAZ_FINE_PROG.ID_COMUNICAZ_FINE_PROG = FILE_ENTITA.ID_TARGET) AND FILE_ENTITA.ID_PROGETTO IS NOT NULL
