...
select distinct
PBANDI_T_DOCUMENTO_INDEX.ID_DOCUMENTO_INDEX , PBANDI_T_DOCUMENTO_INDEX.VERSIONE, NOTE_DOCUMENTO_INDEX, NOME_FILE , NOME_DOCUMENTO,
NOME_DOCUMENTO_FIRMATO, NOME_DOCUMENTO_MARCATO,
...
(select ID_ENTITA, ID_TARGET ,ID_TIPO_DOCUMENTO_INDEX, ID_PROGETTO,max(versione)  
