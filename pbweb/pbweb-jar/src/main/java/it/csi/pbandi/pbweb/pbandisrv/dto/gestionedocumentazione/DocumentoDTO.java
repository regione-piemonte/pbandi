...
public class DocumentoDTO implements java.io.Serializable {
	...
	private String flagTrasmDest = null;

	public String getFlagTrasmDest() {
		return flagTrasmDest;
	}

	public void setFlagTrasmDest(String flagTrasmDest) {
		this.flagTrasmDest = flagTrasmDest;
	}
	
	
	private String flagFirmaAutografa;
	
	public void setFlagFirmaAutografa(java.lang.String val) {
		flagFirmaAutografa = val;
	}

	
	public java.lang.String setFlagFirmaAutografa() {
	...
	public String toString() {
		return "DocumentoDTO [beneficiario=" + beneficiario + ", codiceVisualizzato=" + codiceVisualizzato
				+ ", codStatoDoc=" + codStatoDoc + ", codTipoDoc=" + codTipoDoc + ", descErrore=" + descErrore
				+ ", descTipoDocIndex=" + descTipoDocIndex + ", dtCreazione=" + dtCreazione + ", dtSign=" + dtSign
				+ ", dtTimestamp=" + dtTimestamp + ", flagFirmaCartacea=" + flagFirmaCartacea + ", idDocumentoIndex="
				+ idDocumentoIndex + ", idProgetto=" + idProgetto + ", noteDocumentoIndex=" + noteDocumentoIndex
				+ ", nomeFile=" + nomeFile + ", protocollo=" + protocollo + ", signable=" + signable + ", signed="
				+ signed + ", signValid=" + signValid + ", timeStamped=" + timeStamped + ", sizeFile=" + sizeFile
				+ ", tipoInvioDs=" + tipoInvioDs + ", idCategAnagraficaMitt=" + idCategAnagraficaMitt
				+ ", descCategAnagraficaMitt=" + descCategAnagraficaMitt + ", idEntita=" + idEntita + ", idTarget="
				+ idTarget + ", flagTrasmDest=" + flagTrasmDest + "]";
	}
