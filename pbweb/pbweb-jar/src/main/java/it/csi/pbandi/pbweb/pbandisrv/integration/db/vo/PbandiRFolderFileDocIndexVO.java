...
public class PbandiRFolderFileDocIndexVO extends GenericVO {
	...
	public void setIdUtenteAgg(BigDecimal idUtenteAgg) {
 	...
 	public PbandiRFolderFileDocIndexVO() {}
  	
	public PbandiRFolderFileDocIndexVO (BigDecimal idDocumentoIndex) {
	
		this. idDocumentoIndex =  idDocumentoIndex;
	}
  	
	public PbandiRFolderFileDocIndexVO ( Date dtInserimento, BigDecimal idDocumentoIndex , BigDecimal idFolder, BigDecimal idUtenteIns, String nomeFile, BigDecimal sizeFile ) {
