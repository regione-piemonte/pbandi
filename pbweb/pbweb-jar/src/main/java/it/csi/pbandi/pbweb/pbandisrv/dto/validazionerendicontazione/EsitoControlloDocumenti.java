...
////{PROTECTED REGION ID(R-71527580) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoControlloDocumenti.
 * Consigli:
 * <ul>
...
public class EsitoControlloDocumenti implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1301769181) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-514035222) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-2104422318) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R2146104765) ENABLED START*/
