...
////{PROTECTED REGION ID(R-825915812) ENABLED START////}
/**
...
public class CodiceDescrizioneDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R469848943) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R239054195) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1056286767) ENABLED START*/
