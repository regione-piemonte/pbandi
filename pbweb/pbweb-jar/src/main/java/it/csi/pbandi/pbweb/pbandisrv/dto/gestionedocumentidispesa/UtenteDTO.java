...
////{PROTECTED REGION ID(R137388721) ENABLED START////}
/**
...
public class UtenteDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1215327683) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-827103030) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1793578661) ENABLED START////}
	/**
