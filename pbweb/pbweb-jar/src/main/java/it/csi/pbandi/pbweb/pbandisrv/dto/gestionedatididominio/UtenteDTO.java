...
////{PROTECTED REGION ID(R-192497010) ENABLED START////}
/**
...
public class UtenteDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-204045050) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R2048491533) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-502595198) ENABLED START////}
	/**
