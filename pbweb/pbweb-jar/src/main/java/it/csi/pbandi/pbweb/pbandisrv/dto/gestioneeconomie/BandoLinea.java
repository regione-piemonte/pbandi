...
////{PROTECTED REGION ID(R1129721170) ENABLED START////}
/**
...
public class BandoLinea implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1878511369) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1021457410) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-773411975) ENABLED START*/
