...
public class PbandiCCertCounterVO extends GenericVO {
	...
	public PbandiCCertCounterVO() {}
  	
	public PbandiCCertCounterVO (String msgid, String targetid) {
	
		this. msgid =  msgid;
		this. targetid =  targetid;
	}
  	
	public PbandiCCertCounterVO (String msgid, BigDecimal numAttempts, String targetid) {
