...
////{PROTECTED REGION ID(R-233221162) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoControlloPagamenti.
 * Consigli:
 * <ul>
...
public class EsitoControlloPagamenti implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1081724785) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-575695652) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1967864032) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1525132299) ENABLED START*/
