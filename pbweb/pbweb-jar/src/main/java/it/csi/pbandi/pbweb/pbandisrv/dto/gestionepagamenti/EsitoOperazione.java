...
////{PROTECTED REGION ID(R-1231574718) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoOperazione.
 * Consigli:
 * <ul>
...
public class EsitoOperazione implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R2072710601) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R2063091906) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1456540364) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1772901943) ENABLED START*/
