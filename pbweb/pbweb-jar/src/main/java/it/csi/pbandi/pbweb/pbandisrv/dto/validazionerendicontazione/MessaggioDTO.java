...
////{PROTECTED REGION ID(R1531480016) ENABLED START////}
/**
...
public class MessaggioDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-367251730) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-297638570) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R854271163) ENABLED START*/
