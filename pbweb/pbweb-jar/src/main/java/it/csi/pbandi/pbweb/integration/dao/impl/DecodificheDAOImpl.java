...
public class DecodificheDAOImpl extends JdbcDaoSupport implements DecodificheDAO {
	...
	public List<DecodificaDTO> fornitoriComboRicerca(long idProgetto, HttpServletRequest req) throws InvalidParameterException, Exception {
...
*/
	...
	public boolean dichiarazioneSpesaFinaleConCFP(Long idDichiarazioneDiSpesa) throws DaoException {
		...
		LOG.info("\n"+sqlDS);
		Long idTipoDS = (Long) getJdbcTemplate().queryForObject(sqlDS, Long.class);	
	...
	public Long idComunicazioneFineProgetto(Long idProgetto) {
		...
		LOG.info("\n"+sqlCFP);
		Long idCFP = (Long) getJdbcTemplate().queryForObject(sqlCFP, Long.class);
