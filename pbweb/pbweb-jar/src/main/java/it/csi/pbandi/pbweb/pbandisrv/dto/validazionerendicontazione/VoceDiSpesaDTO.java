...
////{PROTECTED REGION ID(R269147721) ENABLED START////}
/**
...
public class VoceDiSpesaDTO implements java.io.Serializable {
	 ...
	 * @generated
	 */
	public void setDescVoceSpesa(java.lang.String val) {
		descVoceSpesa = val;
	}

	////{PROTECTED REGION ID(R477914785) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo descVoceSpesa. 
	 * Descrivere:
	 * <ul>
	...
	////{PROTECTED REGION ID(R-1597334431) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R13726590) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo idQuotaParte. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	...
	////{PROTECTED REGION ID(R-917488030) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R230612896) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1263644377) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo importoAssociato. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	...
	////{PROTECTED REGION ID(R1809911434) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R426449729) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-778666412) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R761746407) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo oreLavorate. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	...
	/*PROTECTED REGION ID(R-158679966) ENABLED START*/
