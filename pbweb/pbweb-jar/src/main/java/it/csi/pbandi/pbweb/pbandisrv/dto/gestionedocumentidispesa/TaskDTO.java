...
////{PROTECTED REGION ID(R1294324837) ENABLED START////}
/**
...
public class TaskDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1418147512) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R964784074) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R204161308) ENABLED START*/
