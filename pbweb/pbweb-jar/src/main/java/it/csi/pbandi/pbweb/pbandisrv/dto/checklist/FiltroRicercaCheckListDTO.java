...
public class FiltroRicercaCheckListDTO implements java.io.Serializable {
	...
	public String toString() {
		return "FiltroRicercaCheckListDTO [idProgetto=" + idProgetto + ", idDichiarazione=" + idDichiarazione
				+ ", codiciStatoCheckList=" + Arrays.toString(codiciStatoCheckList) + ", codiceTipoCheckList="
				+ codiceTipoCheckList + ", dataControllo=" + dataControllo + ", soggettoControllore="
				+ soggettoControllore + ", flagRilevazioneIrregolarita=" + flagRilevazioneIrregolarita + ", versione="
				+ versione + "]";
	}
