...
public class ControlloTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ControlloTypeDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- it.csi.pbandi.pbweb.pbandisrv.dto.checklist.gen.checklistdatamodel.ControlloTypeDescriptor()
    ...
    {
        return it.csi.pbandi.pbweb.pbandisrv.dto.checklist.gen.checklistdatamodel.ControlloType.class;
