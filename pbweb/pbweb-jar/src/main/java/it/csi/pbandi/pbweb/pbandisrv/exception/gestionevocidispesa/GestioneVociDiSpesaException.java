package it.csi.pbandi.pbweb.pbandisrv.exception.gestionevocidispesa;

import it.csi.csi.wrapper.SystemException;
import it.csi.csi.wrapper.UserException;
import it.csi.csi.wrapper.UnrecoverableException;

////{PROTECTED REGION ID(R-1913678835) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione GestioneVociDiSpesaException.
 * Consigli:
 * <ul>
...
public class GestioneVociDiSpesaException extends UserException

{
	 ...
	 * @generated
	 */
	public GestioneVociDiSpesaException(String msg, String nestedExcClassName,
	 ...
	 * @generated
	 */
	public GestioneVociDiSpesaException(String msg, Throwable nested) {
		super(msg, nested);
	}
	 ...
	 * @generated
	 */
	public GestioneVociDiSpesaException(String msg) {
		super(msg);
	}
}
