...
////{PROTECTED REGION ID(R-1711884850) ENABLED START////}
/**
...
public class CodiceDescrizioneDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-774265503) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R350667457) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R784239101) ENABLED START*/
