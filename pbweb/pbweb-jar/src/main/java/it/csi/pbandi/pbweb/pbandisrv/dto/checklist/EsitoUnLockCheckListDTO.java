...
////{PROTECTED REGION ID(R-1597377821) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoUnLockCheckListDTO.
 * Consigli:
 * <ul>
...
public class EsitoUnLockCheckListDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-222394317) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1790739239) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R499815048) ENABLED START*/
