...
public abstract class GenericVO implements Cloneable {
	...
	public boolean hasQueryResource() {
		...
		//System.out.println("hasQueryResource"); //PK
	...
	private static String getQuery(String queryIdentifierKey) {
		...
		//System.out.println("getQuery tableName="+tableName); //PK
		//System.out.println("getQuery queryIdentifierKey="+queryIdentifierKey); //PK
		
		if (tableName == null) {
			InputStream resourceAsStream = getQueryResourceAsStream(queryIdentifierKey);

			//System.out.println("getQuery resourceAsStream="+resourceAsStream); //PK
			...
			if (tableName == null) {
				try {
					...
					//System.out.println("getQuery 2 tableName="+tableName); //PK
	...
	private static InputStream getQueryResourceAsStream(
		...
		//System.out.println("getQueryResourceAsStream getQueryResourceAsStream queryIdentifierKey="+queryIdentifierKey); //PK
		
		//DocumentoDiSpesaProgettoVO
		//System.out.println("getQueryResourceAsStream getQueryResourceAsStream q====="+GenericVO.class.getClassLoader().getResource(queryIdentifierKey + ".sql"));
		
//		InputStream file = getClass().getClassLoader().getResourceAsStream( queryIdentifierKey + ".sql");
