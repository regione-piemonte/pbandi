...
////{PROTECTED REGION ID(R1370543362) ENABLED START////}
/**
 * Inserire qui la documentazione della classe VoceDiSpesaRettificaDTO.
 * Consigli:
 * <ul>
...
public class VoceDiSpesaRettificaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-423380120) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1922475387) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1779984765) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R369329465) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1605441163) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo idQuotaParteDocSpesa. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	...
	////{PROTECTED REGION ID(R-1026225655) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-2147235284) ENABLED START////}
	/**
	 ...
	 * @generated
	 */
	public void setImportoTotaleRettifica(java.lang.Double val) {
		importoTotaleRettifica = val;
	}

	////{PROTECTED REGION ID(R-1866936242) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo importoTotaleRettifica. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	 ...
	 * @generated
	 */
	private java.lang.Double importoValidatoLordo = null;

	/**
	 * @generated
	 */
	public void setImportoValidatoLordo(java.lang.Double val) {
		importoValidatoLordo = val;
	}

	////{PROTECTED REGION ID(R-1422635630) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo importoValidatoLordo. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	 ...
	 */
	////{PROTECTED REGION END////}
	public java.lang.Double getImportoValidatoLordo() {
	...
	////{PROTECTED REGION ID(R1967134402) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R885226527) ENABLED START*/
