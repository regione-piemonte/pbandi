...
////{PROTECTED REGION ID(R1432496984) ENABLED START////}
/**
...
public class UtenteDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1343368316) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-699062397) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R645269580) ENABLED START////}
	/**
