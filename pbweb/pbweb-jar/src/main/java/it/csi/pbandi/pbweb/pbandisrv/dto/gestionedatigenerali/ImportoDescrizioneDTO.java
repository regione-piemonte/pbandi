...
////{PROTECTED REGION ID(R819195924) ENABLED START////}
/**
 * Inserire qui la documentazione della classe ImportoDescrizioneDTO.
 * Consigli:
 * <ul>
...
public class ImportoDescrizioneDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-604733253) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1984074454) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1394394591) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R862368631) ENABLED START*/
