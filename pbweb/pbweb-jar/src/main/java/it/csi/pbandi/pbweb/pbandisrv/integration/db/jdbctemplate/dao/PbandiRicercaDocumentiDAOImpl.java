...
//			 		 .append("BENEFICIARIO as beneficiario ,")
			...
			if(filtro.getDescBreveTipoAnagrafica().equalsIgnoreCase(it.csi.pbandi.pbweb.pbandisrv.util.Constants.DESCRIZIONE_BREVE_TIPO_ANAGRAFICA_OPERATORE_ISTRUTTORIA_PROGETTI)){
