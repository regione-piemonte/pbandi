...
////{PROTECTED REGION ID(R-659490024) ENABLED START////}
/**
...
public class BeneficiarioDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R343840104) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1458480845) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R438458099) ENABLED START*/
