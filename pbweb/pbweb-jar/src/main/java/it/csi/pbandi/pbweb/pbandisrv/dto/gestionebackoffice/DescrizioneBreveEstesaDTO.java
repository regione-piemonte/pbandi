...
////{PROTECTED REGION ID(R-886171502) ENABLED START////}
/**
 * Inserire qui la documentazione della classe DescrizioneBreveEstesaDTO.
 * Consigli:
 * <ul>
...
public class DescrizioneBreveEstesaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1943358241) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R201805360) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R234794511) ENABLED START*/
