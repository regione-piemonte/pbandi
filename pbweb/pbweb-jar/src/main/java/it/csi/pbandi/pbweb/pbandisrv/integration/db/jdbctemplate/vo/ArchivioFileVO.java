...
public class ArchivioFileVO extends GenericVO {
	...
	private Date dtAssociazione;				// Jira PBANDI-2890: nuovo campo PBANDI_T_FILE_ENTITA.DT_ASSOCIAZIONE
	...
	public Date getDtAssociazione() {
		return dtAssociazione;
	}
	public void setDtAssociazione(Date dtAssociazione) {
