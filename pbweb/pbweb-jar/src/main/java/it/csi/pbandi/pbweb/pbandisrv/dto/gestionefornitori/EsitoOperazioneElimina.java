...
////{PROTECTED REGION ID(R1821669605) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoOperazioneElimina.
 * Consigli:
 * <ul>
...
public class EsitoOperazioneElimina implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R843629925) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1576963215) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R271000668) ENABLED START*/
