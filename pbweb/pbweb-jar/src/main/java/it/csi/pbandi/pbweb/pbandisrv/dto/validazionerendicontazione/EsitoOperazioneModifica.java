...
////{PROTECTED REGION ID(R-2095660030) ENABLED START////}
/**
...
public class EsitoOperazioneModifica implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R2041746036) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1731335621) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-831835128) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1147475039) ENABLED START*/
