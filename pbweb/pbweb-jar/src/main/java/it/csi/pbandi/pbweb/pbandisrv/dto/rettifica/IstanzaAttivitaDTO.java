...
////{PROTECTED REGION ID(R-537053995) ENABLED START////}
/**
...
public class IstanzaAttivitaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-712810320) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1688266148) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-2104690922) ENABLED START*/
