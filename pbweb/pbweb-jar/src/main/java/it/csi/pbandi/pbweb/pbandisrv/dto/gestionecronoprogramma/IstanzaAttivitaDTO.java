...
////{PROTECTED REGION ID(R1687873208) ENABLED START////}
/**
...
public class IstanzaAttivitaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1451481645) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1538775001) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R903456659) ENABLED START*/
