...
////{PROTECTED REGION ID(R241081261) ENABLED START////}
/**
...
public class EsitoOperazioneModifica implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-393884247) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1847809978) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R973037427) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-236843308) ENABLED START*/
