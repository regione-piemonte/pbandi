package it.csi.pbandi.pbweb.pbandisrv.business.digitalsign;
...
import it.csi.pbandi.pbweb.pbandisrv.integration.db.vo.PbandiDSistemaProtocolloVO;
...
import it.csi.pbandi.pbweb.pbandisrv.interfacecsi.digitalsign.DigitalSignSrv;
...
public class DigitalSignBusinessImpl extends BusinessImpl implements
DigitalSignSrv {
...
*/
	public String signFile(Long idUtente, String identitaDigitale,
		...
		try{			  
			  ...
			  // +Green: verifico se il progetto e' un +Green di tipo contributo.
			  ...
			  logger.info("idSoggRappLegale : "+idSoggRappLegale + " , idSoggDelegato:"+idSoggDelegato);
			  if(idSoggRappLegale!=null){
				  ...
				  // +Green: se non trovo nulla ed e' un progetto contributo, provo col progetto finanziamento.
