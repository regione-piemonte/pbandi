...
import it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.VoceDiCostoVO;
...
public class PbandiDichiarazioneDiSpesaDAOImpl extends PbandiDAO {
	...
	public Long inserisci(DichiarazioneDiSpesaVO dichiarazioneDiSpesaVO) {
			...
			StringBuffer sqlInsert= new StringBuffer("insert into PBANDI_T_DICHIARAZIONE_SPESA ");
			 ...
			 params.addValue("dtDichiarazione",dichiarazioneDiSpesaVO.getDataDichiarazioneDiSpesa(),Types.DATE);	// Jira PBANDI-3070
	...
	public void inserisciDocumentoPagamentiDichiarazione(BigDecimal idDichiarazione, BigDecimal idDocumento, List<BigDecimal> idPagamenti) throws Exception {
		
		if (idPagamenti == null) {
			logger.info("inserisciDocumentoPagamentiDichiarazione(): idPagamenti = NULL");
		} else {
			for (BigDecimal p : idPagamenti) { 
				logger.info("inserisciDocumentoPagamentiDichiarazione(): idPagamento = "+p.longValue());
			}
		}
				
		// NOTA: nella versione installata: 
		// getDataSource().getConnection().getClass().getName() = org.jboss.jca.adapters.jdbc.jdk8.WrappedConnectionJDK8
		// mentre con JUnit:
		// getDataSource().getConnection().getClass().getName() = oracle.jdbc.driver.T4CConnection
		...
		try {
			...
			// caso semplice che funziona con JUnit ma non con la versione installata.
			
			// versione installata:    ERRORE: java.lang.ClassCastException: 
			// org.jboss.jca.adapters.jdbc.jdk8.WrappedConnectionJDK8 cannot be cast to oracle.jdbc.OracleConnection								
			
			/*
			logger.info("JUNIT: ESEGUO ArrayDescriptor.createDescriptor()");
			ArrayDescriptor arrayDescriptor = ArrayDescriptor.createDescriptor("T_NUMBER_ARRAY", getDataSource().getConnection());
			
			logger.info("INIZIALIZZO oracleArray");
			oracleArray = new oracle.sql.ARRAY(arrayDescriptor, getDataSource().getConnection(), idPagamenti.toArray(new BigDecimal []{}));		    
			*/
			...
			// Soluzione per la versione installata basata su
			// https://stackoverflow.com/questions/54652524/how-to-cast-from-org-jboss-jca-adapters-jdbc-jdk8-wrappedconnectionjdk8-to-oracl
			
			// Per funzionare ha richiesto di inserire in jboss-deployment-structure.xml
			//    <module name="com.oracle" />
			// Altrimenti dava il seguente errore:
			// ERRORE: java.lang.ClassCastException: oracle.jdbc.driver.T4CConnection cannot be cast to oracle.jdbc.OracleConnection
			...
			//Object[] paramsConArray = new Object[] { idDichiarazione, idDocumento, oracleArray };
			MapSqlParameterSource params = new MapSqlParameterSource();
	...
	*/
	...
	RowMapper<it.csi.pbandi.pbweb.pbandisrv.integration.db.vo.PbandiRFornitoreQualificaVO>{

		public it.csi.pbandi.pbweb.pbandisrv.integration.db.vo.PbandiRFornitoreQualificaVO mapRow(ResultSet rs, int row) throws SQLException {
			
			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbweb.pbandisrv.integration.db.vo.PbandiRFornitoreQualificaVO vo=
				(it.csi.pbandi.pbweb.pbandisrv.integration.db.vo.PbandiRFornitoreQualificaVO) beanMapper.toBean(rs,
						it.csi.pbandi.pbweb.pbandisrv.integration.db.vo.PbandiRFornitoreQualificaVO.class);
			 return vo;
		}
	}
...
// PBANDI-2314			conditionListSpesaValidata.add(new StringBuilder("PBANDI_D_STATO_VALIDAZ_SPESA.DESC_BREVE_STATO_VALIDAZ_SPESA IN ('V','P')"));
	...
	public List<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO> getPagamenti (Long idDocumentoDiSpesa) {
			List<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO> result = new ArrayList<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO>();
	...
	public List<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO> getPagamenti (Long idDocumentoDiSpesa, Long idProgetto) {
			List<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO> result = new ArrayList<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO>();
	...
	public it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO getTotaleQuietanzati (Long idDocumentoDiSpesa, Long idProgetto) {
			it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO result = new it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO();
	...
	RowMapper<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.RappresentanteLegaleDichiarazioneVO>{

		public it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.RappresentanteLegaleDichiarazioneVO mapRow(ResultSet rs, int row) throws SQLException {
			
			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.RappresentanteLegaleDichiarazioneVO vo=
				(it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.RappresentanteLegaleDichiarazioneVO) beanMapper.toBean(rs,
						it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.RappresentanteLegaleDichiarazioneVO.class);
			 return vo;
		}
	}
	
	private class BeneficiarioVORowMapper implements 
	RowMapper<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.BeneficiarioVO>{

		public it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.BeneficiarioVO mapRow(ResultSet rs, int row) throws SQLException {
			
			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.BeneficiarioVO vo=
				(it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.BeneficiarioVO) beanMapper.toBean(rs,
						it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.BeneficiarioVO.class);
			 return vo;
		}
	}
	...
	RowMapper<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoContabileVO>{

		public it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoContabileVO mapRow(ResultSet rs, int row) throws SQLException {
			
			BeanMapper beanMapper = new BeanMapper();
		 
			it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoContabileVO vo=
				(it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoContabileVO) beanMapper.toBean(rs,
						it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.DocumentoContabileVO.class);
	...
	RowMapper<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.ProgettoVO>{

		public it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.ProgettoVO mapRow(ResultSet rs, int row) throws SQLException {
			
			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.ProgettoVO vo=
				(it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.ProgettoVO) beanMapper.toBean(rs,
						it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.ProgettoVO.class);
			 return vo;
		}
	}
	...
	RowMapper<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.EnteAppartenenzaVO>{

		public it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.EnteAppartenenzaVO mapRow(ResultSet rs, int row) throws SQLException {
			
			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.EnteAppartenenzaVO vo=
				(it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.EnteAppartenenzaVO) beanMapper.toBean(rs,
						it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.EnteAppartenenzaVO.class);
			 return vo;
		}
	}
	...
	RowMapper<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.VoceDiCostoVO>{

		public it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.VoceDiCostoVO mapRow(ResultSet rs, int row) throws SQLException {
			
			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.VoceDiCostoVO vo=
				(it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.VoceDiCostoVO) beanMapper.toBean(rs,
						it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.dichiarazionedispesa.VoceDiCostoVO.class);
			 return vo;
		}
	}
	
	private class PagamentoQuotePartiVORowMapper implements 
	RowMapper<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO>{

		public it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO mapRow(ResultSet rs, int row) throws SQLException {
			
			BeanMapper beanMapper = new BeanMapper();
			it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO vo=
				(it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO) beanMapper.toBean(rs,
						it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO.class);
			 return vo;
		}
	}
	...
	public List<it.csi.pbandi.pbweb.pbandisrv.integration.db.jdbctemplate.vo.gestionepagamenti.PagamentoQuotePartiVO> getPagamentiAssociatiAVociDiSpesa (Long idDocumentoDiSpesa, Long idProgetto) {
	...
	public List<DocumentoDiSpesaDichiarazioneVO> findDichiarazioni(Long idProgetto,Long idDocumentoDiSpesa) {
		...
		.append(" DICH.ID_UTENTE_INS idUtenteIns,")
