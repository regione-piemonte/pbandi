...
package it.csi.pbandi.pbweb.pbandisrv.interfacecsi.neoflux;

import it.csi.pbandi.pbweb.pbandisrv.dto.neoflux.*;
import it.csi.pbandi.pbweb.pbandisrv.exception.neoflux.*;
...
public interface NeofluxSrv {
	...
	java.lang.Long idNotifica
			...
			, it.csi.pbandi.pbweb.pbandisrv.exception.neoflux.NeoFluxException;
	 ...
	 * @return it.csi.pbandi.pbweb.pbandisrv.dto.neoflux.TaskDTO[]
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbweb.pbandisrv.dto.neoflux.TaskDTO[] getAttivita(
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbweb.pbandisrv.dto.neoflux.TaskDTO[] getAttivitaBEN(
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbweb.pbandisrv.dto.neoflux.TaskDTO[] getAttivitaBL(
	 ...
	 * @return it.csi.pbandi.pbweb.pbandisrv.dto.neoflux.BandoDTO[]
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbweb.pbandisrv.dto.neoflux.BandoDTO[] getBandi(
	 ...
	 * @return it.csi.pbandi.pbweb.pbandisrv.dto.neoflux.NotificaDTO
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbweb.pbandisrv.dto.neoflux.NotificaDTO getNotificationMessage(
	 ...
	 */
	////{PROTECTED REGION END////}
	public it.csi.pbandi.pbweb.pbandisrv.dto.neoflux.ProgettoDTO[] getProgetti(
	...
	public void endAttivitaDsFinale(
	java.lang.Long idUtente,
	java.lang.String identitaDigitale,
	java.lang.Long idProgetto
	) throws it.csi.csi.wrapper.CSIException,
