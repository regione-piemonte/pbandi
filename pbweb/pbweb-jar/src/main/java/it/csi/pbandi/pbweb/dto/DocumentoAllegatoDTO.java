...
public class DocumentoAllegatoDTO implements java.io.Serializable {
	...
	private java.lang.String dtInvioIntegrazione = null;


	public String getDtInvioIntegrazione() {
		return dtInvioIntegrazione;
	}

	public void setDtInvioIntegrazione(String dtInvioIntegrazione) {
		this.dtInvioIntegrazione = dtInvioIntegrazione;
	}
