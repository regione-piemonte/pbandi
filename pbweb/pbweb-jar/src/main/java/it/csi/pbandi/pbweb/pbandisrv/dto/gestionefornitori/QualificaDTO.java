...
////{PROTECTED REGION ID(R-1514494446) ENABLED START////}
/**
 * Inserire qui la documentazione della classe QualificaDTO.
 * Consigli:
 * <ul>
...
public class QualificaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-941265654) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1733503992) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1352785462) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-2117136379) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-917713874) ENABLED START////}
	/**
	 ...
	 * @generated
	 */
	public void setNoteQualifica(java.lang.String val) {
		noteQualifica = val;
	}

	////{PROTECTED REGION ID(R-2099677257) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo noteQualifica. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	...
	////{PROTECTED REGION ID(R-1856227217) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1884283855) ENABLED START*/
