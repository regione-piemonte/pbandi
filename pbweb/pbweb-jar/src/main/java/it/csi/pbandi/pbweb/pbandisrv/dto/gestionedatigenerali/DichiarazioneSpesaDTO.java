...
////{PROTECTED REGION ID(R1007902633) ENABLED START////}
/**
 * Inserire qui la documentazione della classe DichiarazioneSpesaDTO.
 * Consigli:
 * <ul>
...
public class DichiarazioneSpesaDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-1901668248) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1991282612) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R116173250) ENABLED START*/
