...
////{PROTECTED REGION ID(R840617221) ENABLED START////}
/**
...
public class MessaggioDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-586090397) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-516477237) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R170008934) ENABLED START*/
