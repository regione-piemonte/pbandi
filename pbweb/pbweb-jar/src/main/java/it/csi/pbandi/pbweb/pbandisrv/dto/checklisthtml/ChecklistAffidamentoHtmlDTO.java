...
////{PROTECTED REGION ID(R-57831601) ENABLED START////}
/**
 * Inserire qui la documentazione della classe ChecklistAffidamentoHtmlDTO.
 * Consigli:
 * <ul>
...
public class ChecklistAffidamentoHtmlDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R891629888) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R491644181) ENABLED START////}
	/**
	 ...
	 * @generated
	 */
	private java.lang.String fasiHtml = null;

	/**
	 * @generated
	 */
	public void setFasiHtml(java.lang.String val) {
		fasiHtml = val;
	}

	////{PROTECTED REGION ID(R1405653995) ENABLED START////}
	/**
	 * Inserire qui la documentazione dell'attributo fasiHtml. 
	 * Descrivere:
	 * <ul>
	 *      <li>se l'attributo deve essere sempre valoriuzzato o meno
	 *      <li>se ci sono dei vincoli sulla valorizzazione (es. range numerico,
	 ...
	 */
	////{PROTECTED REGION END////}
	public java.lang.String getFasiHtml() {
		return fasiHtml;
	}
	...
	////{PROTECTED REGION ID(R1111591964) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-143534648) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R129904782) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R2139394206) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R13364735) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-2044017150) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1177849444) ENABLED START*/
