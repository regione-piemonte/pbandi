...
// EX it.csi.pbandi.pbandiweb.dto.Fornitore
...
public class Fornitore implements java.io.Serializable {
	...
	private boolean isLinkAllegaFileVisible = false;
	...
	public void setLinkAllegaFileVisible(boolean isLinkAllegaFileVisible) {
	...
	public java.lang.String getLinkQualifiche() {
		return linkQualifiche;
	}



	public void setLinkQualifiche(java.lang.String linkQualifiche) {
		this.linkQualifiche = linkQualifiche;
	}



	public java.lang.String getLinkCancella() {
		return linkCancella;
	}



	public void setLinkCancella(java.lang.String linkCancella) {
		this.linkCancella = linkCancella;
	}
	...
	public String toString() {
		...
		builder.append("Fornitore [_altroCodice=");
		builder.append(altroCodice);
		builder.append(", _codUniIpa=");
		builder.append(codUniIpa);
		builder.append(", _codiceFiscaleFornitore=");
		builder.append(codiceFiscaleFornitore);
		builder.append(", _cognomeFornitore=");
		builder.append(cognomeFornitore);
		builder.append(", _costoOrario=");
		builder.append(costoOrario);
		builder.append(", _costoRisorsa=");
		builder.append(costoRisorsa);
		builder.append(", _denominazioneFornitore=");
		builder.append(denominazioneFornitore);
		builder.append(", _descQualifica=");
		builder.append(descQualifica);
		builder.append(", _descTipoSoggetto=");
		builder.append(descTipoSoggetto);
		builder.append(", _documentiAllegati=");
		builder.append(documentiAllegati);
		builder.append(", _flagPubblicoPrivato=");
		builder.append(flagPubblicoPrivato);
		builder.append(", _idAttivitaAteco=");
		builder.append(idAttivitaAteco);
		builder.append(", _idFormaGiuridica=");
		builder.append(idFormaGiuridica);
		builder.append(", _idFornitore=");
		builder.append(idFornitore);
		builder.append(", _idNazione=");
		builder.append(idNazione);
		builder.append(", _idQualifica=");
		builder.append(idQualifica);
		builder.append(", _idSoggettoFornitore=");
		builder.append(idSoggettoFornitore);
		builder.append(", _idTipoSoggetto=");
		builder.append(idTipoSoggetto);
		builder.append(", _isInvalid=");
		builder.append(isInvalid);
		builder.append(", _isLinkAllegaFileVisible=");
		builder.append(isLinkAllegaFileVisible);
		builder.append(", _linkCancella=");
		builder.append(linkCancella);
		builder.append(", _linkModifica=");
		builder.append(linkModifica);
		builder.append(", _linkQualifiche=");
		builder.append(linkQualifiche);
		builder.append(", _monteOre=");
		builder.append(monteOre);
		builder.append(", _nomeFornitore=");
		builder.append(nomeFornitore);
		builder.append(", _partitaIvaFornitore=");
		builder.append(partitaIvaFornitore);
		builder.append("]");
