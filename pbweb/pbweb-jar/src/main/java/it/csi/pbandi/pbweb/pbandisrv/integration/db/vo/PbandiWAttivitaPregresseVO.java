...
// identica alla classe it.csi.pbandi.pbservizit.pbandisrv.integration.db.vo.PbandiWAttivitaPregresseVO;

// usa file di query "AttivitaPregresseVO.sql" presente in pbservizit.jar 
