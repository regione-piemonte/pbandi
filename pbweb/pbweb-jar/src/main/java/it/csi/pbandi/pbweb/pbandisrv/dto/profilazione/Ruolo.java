...
////{PROTECTED REGION ID(R1447567458) ENABLED START////}
/**
 * Inserire qui la documentazione della classe Ruolo.
 * Consigli:
 * <ul>
...
public class Ruolo implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-457073411) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R757248941) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1453521879) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R465151694) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-941848407) ENABLED START*/
