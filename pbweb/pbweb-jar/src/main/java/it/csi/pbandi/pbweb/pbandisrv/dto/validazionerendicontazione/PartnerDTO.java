...
////{PROTECTED REGION ID(R-479676585) ENABLED START////}
/**
...
public class PartnerDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1194786424) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1611947624) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1748527340) ENABLED START*/
