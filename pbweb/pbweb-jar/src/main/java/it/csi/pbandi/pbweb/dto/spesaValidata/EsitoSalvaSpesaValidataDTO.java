...
public class EsitoSalvaSpesaValidataDTO implements java.io.Serializable {
	...
	private Boolean chiedereConfermaPerProseguire;
	
	public Boolean getChiedereConfermaPerProseguire() {
		return chiedereConfermaPerProseguire;
	}
	public void setChiedereConfermaPerProseguire(Boolean chiedereConfermaPerProseguire) {
		this.chiedereConfermaPerProseguire = chiedereConfermaPerProseguire;
	}
