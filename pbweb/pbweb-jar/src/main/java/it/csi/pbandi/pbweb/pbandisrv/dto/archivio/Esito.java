...
////{PROTECTED REGION ID(R-2127606958) ENABLED START////}
/**
 * Inserire qui la documentazione della classe Esito.
 * Consigli:
 * <ul>
...
public class Esito implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1901731108) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1588584669) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R320975989) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-877330600) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R1605055033) ENABLED START*/
