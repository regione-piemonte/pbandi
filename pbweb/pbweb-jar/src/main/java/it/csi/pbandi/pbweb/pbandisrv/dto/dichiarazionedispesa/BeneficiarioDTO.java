...
////{PROTECTED REGION ID(R-784340427) ENABLED START////}
/**
...
public class BeneficiarioDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1374220523) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1158307626) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R247925622) ENABLED START*/
