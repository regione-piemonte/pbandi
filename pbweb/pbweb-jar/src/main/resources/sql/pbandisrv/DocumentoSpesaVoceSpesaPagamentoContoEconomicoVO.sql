  select rce.id_conto_economico,
       ...
       docProg.tipo_invio,
       docProg.rilievo_contabile,
       docProg.dt_rilievo_contabile,
       case 
...
PBANDI_T_RIGO_CONTO_ECONOMICO rce,
     ...
     (
       select ds.id_documento_di_spesa,
              ...
              rdsp.task,
              rdsp.tipo_invio,
              rdsp.rilievo_contabile,
              rdsp.dt_rilievo_contabile
       ...
       where ds.id_tipo_documento_spesa = tds.id_tipo_documento_spesa
         and rdsp.id_stato_documento_spesa_valid = sds.id_stato_documento_spesa
