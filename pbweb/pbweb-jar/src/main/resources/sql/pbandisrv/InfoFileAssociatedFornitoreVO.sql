...
JOIN PBANDI_T_FILE_ENTITA FILE_ENTITA ON FILE_ENTITA.ID_FILE=PBANDI_T_FILE.ID_FILE AND 
 FILE_ENTITA.ID_ENTITA=(SELECT ID_ENTITA FROM PBANDI_C_ENTITA WHERE UPPER(NOME_ENTITA)=UPPER('PBANDI_T_FORNITORE'))
JOIN PBANDI_T_FORNITORE PBANDI_T_FORNITORE
ON (PBANDI_T_FORNITORE.ID_FORNITORE = FILE_ENTITA.ID_TARGET)
