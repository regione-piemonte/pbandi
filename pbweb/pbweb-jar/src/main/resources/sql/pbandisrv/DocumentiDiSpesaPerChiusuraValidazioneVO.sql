with tot_rendicont as
       (select id_documento_di_spesa,sum(importo_rendicontazione) as totale_rendicontabili
...
(
 ...
 join tot_rendicont tr on tr.id_documento_di_spesa = documento.id_documento_di_spesa,
(
