...
CONTO_ECONOMICO.ID_CONTO_ECONOMICO ID_CONTO_ECONOMICO,
DOCINDEX.DT_INSERIMENTO_INDEX  DT_PROPOSTA,   
...
JOIN PBANDI_T_FILE_ENTITA FILE_ENTITA ON FILE_ENTITA.ID_FILE=PBANDI_T_FILE.ID_FILE AND 
 FILE_ENTITA.ID_ENTITA=(SELECT ID_ENTITA FROM PBANDI_C_ENTITA WHERE UPPER(NOME_ENTITA)=UPPER('PBANDI_T_CONTO_ECONOMICO'))
JOIN PBANDI_T_CONTO_ECONOMICO  CONTO_ECONOMICO
ON (CONTO_ECONOMICO.ID_CONTO_ECONOMICO = FILE_ENTITA.ID_TARGET) AND FILE_ENTITA.ID_PROGETTO IS NOT NULL
