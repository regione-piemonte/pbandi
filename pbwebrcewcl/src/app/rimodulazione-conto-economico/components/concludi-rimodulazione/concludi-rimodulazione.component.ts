...
import { FinanziamentoFonteFinanziaria, FonteFinanziaria } from '../../commons/dto/finanziamento-fonte-finanziaria';
...
import { ModificaFonteFinanziariaDialogComponent } from '../modifica-fonte-finanziaria-dialog/modifica-fonte-finanziaria-dialog.component';

const PERIODO_CODICE_UNICO: number = 1;

@Component({
  selector: 'app-concludi-rimodulazione',
  templateUrl: './concludi-rimodulazione.component.html',
  styleUrls: ['./concludi-rimodulazione.component.scss']
})
@AutoUnsubscribe({ objectName: 'subscribers' })
export class ConcludiRimodulazioneComponent implements OnInit {
