...
import { LineaInterventoDTO } from '../../../shared/commons/dto/linea-intervento-dto'
...
@Component({
  selector: 'app-carica-dichiarazione-finale',
  templateUrl: './carica-dichiarazione-finale.component.html',
  styleUrls: ['./carica-dichiarazione-finale.component.scss']
})
@AutoUnsubscribe({ objectName: 'subscribers' })
export class CaricaDichiarazioneFinaleComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.subscribers.userInfo$ = this.userService.userInfo$.subscribe(data => {
      if (data) {
        ...
        let requestProposte = new ProposteCertificazioneRequest(this.user, new Array<string>());
  ...
  goToGestioneDichiarazione(idProposta: number) {
    this.router.navigateByUrl("/drawer/" + Constants.ID_OPERAZIONE_CERTIFICAZIONE_CARICA_DICHIARAZIONE_FINALE + "/gestioneDichiarazioneFinale/" + idProposta);
  }
