...
package it.csi.pbandi.pbgestfinbo.business.service.gestioneGaranzie;
...
@Path("/gestioneGaranzie")
public interface GestioneGaranzieService {
	
	// Ricerca //
	
	@GET
	@Path("/initRicercaGaranzie")
	@Produces(MediaType.APPLICATION_JSON)
	Response initRicercaGaranzie(
	...
	Response ricercaGaranzie(
			...
			@DefaultValue("") @QueryParam("codiceFinpis") String codiceFinpis,
			@Context HttpServletRequest req) throws Exception;
	...
	@GET
	@Path("/getDettaglioRevocaBancaria")
	@Produces(MediaType.APPLICATION_JSON)
	Response getDettaglioRevocaBancaria ( 
			@DefaultValue("0") @QueryParam("idProgetto") Long idProgetto,
	        @Context HttpServletRequest req) throws Exception;
	
	@GET
	@Path("/getDettaglioAzioneRecuperoBanca")
	@Produces(MediaType.APPLICATION_JSON)
	Response getDettaglioAzioneRecuperoBanca (
			@DefaultValue("0") @QueryParam("idProgetto") Long idProgetto,
	        @Context HttpServletRequest req) throws Exception;	
	
	@GET
	@Path("/getDettaglioSaldoStralcio")
	@Produces(MediaType.APPLICATION_JSON)
	Response getDettaglioSaldoStralcio (
			@DefaultValue("0") @QueryParam("idProgetto") Long idProgetto,
	        @Context HttpServletRequest req) throws Exception;		
	...
	@GET
	@Path("/getAllegatiEscussione") 
	@Produces(MediaType.APPLICATION_JSON)
	Response getAllegatiEscussione( 
