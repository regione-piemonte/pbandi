...
package it.csi.pbandi.pbgestfinbo.integration.dao.gestioneGaranzie;
...
public interface GestioneGaranzieDAO {
	
	// Ricerca //
	
	List<String> initRicercaGaranzie();
	
	List<String> getSuggestions(String value, String id) throws Exception;
	
	List<DatiGaranziaVO> ricercaGaranzie(String descrizioneBando, String codiceProgetto, String codiceFiscale, String ndg, String partitaIva, String denominazioneCognomeNome, String statoEscussione, String denominazioneBanca, String codiceFinpis, Long idUtente) throws Exception;
	
	InfoDettaglioRicercaGaranzieVO getDettaglioRevocaBancaria(Long idProgetto, Long idUtente) throws Exception;
	List<InfoDettaglioRicercaGaranzieVO> getDettaglioAzioneRecuperoBanca(Long idProgetto, Long idUtente) throws Exception;
	List<InfoDettaglioRicercaGaranzieVO> getDettaglioSaldoStralcio(Long idProgetto, Long idUtente) throws Exception;
	
	
	// Gestione Escussione //	
	
	List<GestioneAllegatiVO> getAllegatiEscussione(Long idEscussione) throws Exception;
