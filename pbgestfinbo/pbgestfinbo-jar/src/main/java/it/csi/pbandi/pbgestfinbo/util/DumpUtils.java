...
//package it.csi.findom.finistr.util;
//
...
//
//import it.csi.findom.finistr.exception.InternalUnexpectedException;
//import it.csi.findom.finistr.integration.dto.internal.ILoggable;
//import it.csi.findom.finistr.integration.dto.internal.LogParameter;
//import it.csi.findom.finistr.integration.dto.internal.LogVariable;
//
...
//
//  public static void logInternalUnexpectedException(Logger logger, InternalUnexpectedException e, String logHeader)
//  {
//    logGenericException(logger, e.getQuery(), e.getCause(), e.getParameters(), e.getVariables(), logHeader);
//  }
//
//  private static final String semaphore       = "ID";
//  static public long          lastExceptionID = 0;
//
//  public static void logGenericException(Logger logger, String query, Throwable e, LogParameter[] parameters, LogVariable variables[], String logHeader)
//  {
//    String xmlParameters = dump(parameters, "Parametri");
//    String xmlVariables = dump(variables, "Variabili");
//    logGenericException(logger, query, e, xmlParameters, xmlVariables, logHeader);
//  }
//
//  public static void logGenericException(Logger logger, String query, Throwable e, String xmlParameters, String xmlVariables, String logHeader)
//  {
//    long id = getUniqueId();
//    logHeader += " [ID = " + id + "] ";
//    logger.error(logHeader + " *********************************** INIZIO DUMP ECCEZIONE  ***********************************");
...
//    logger.error(logHeader + " ************************************ FINE DUMP ECCEZIONE *************************************");
//  }
//
...
//      // XMLStreamWriter writer = new IndentingXMLStreamWriter(factory.createXMLStreamWriter(xmlOutputStream));
...
//    catch (Exception e)
//    {
//      return "<" + name + ">Eccezione nella generazione dell'xml di dump dell'oggetto " + name + "<" + name + ">";
//    }
//  }
//
//  public static void dump(int recursionDepth, XMLStreamWriter writer, Object obj, String name) throws XMLStreamException
//  {
...
//    {
//      // Non incremento il recursionDepth in quanto sto scrivendo l'oggetto corrente (forzato ad un altro tipo)
...
//          {
//            // Array generico di byte ==> potrebbe essere un blob == devo valutare se abbia senso scriverlo
...
//            {
//              writer.writeCharacters("ATTENZIONE: Array di byte con dimensione superiore a " + MAX_RAW_BYTE_ARRAY_SIZE
...
//            {
//              dump(recursionDepth + 1, writer, iterator.next(), name + (index++));
//            }
//            writer.writeEndElement();
//          }
//          else
...
//  {
//    return obj instanceof Number || obj instanceof CharSequence || obj instanceof java.util.Date || obj instanceof Boolean;
//  }
//
//  private static void writeMaxRecursionException(XMLStreamWriter writer) throws XMLStreamException
//  {
//    writer.writeStartElement("MaxRecursionException");
//    writer.writeEndElement();
//  }
//
//  public static void dump(int recursionDepth, XMLStreamWriter writer, ILoggable obj, String name) throws XMLStreamException
//  {
//    if (recursionDepth > MAX_RECURSION)
//    {
//      writeMaxRecursionException(writer);
...
//  }
//
//  private static void writePrimitive(XMLStreamWriter writer, Object value, String name) throws XMLStreamException
//  {
//    writer.writeStartElement(name);
//    try
//    {
