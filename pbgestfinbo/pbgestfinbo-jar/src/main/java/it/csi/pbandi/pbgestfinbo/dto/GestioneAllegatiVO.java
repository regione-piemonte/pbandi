...
public class GestioneAllegatiVO {
	...
	private BigDecimal idProgetto;
  	...
  	private String nomeNuovoAllegato;  	
  	private String nuovoAllegatoFileSize;  	
  	private MultipartFile nuovoAllegato;			// Il file nativo dall'allegato caricato, non usato nel BE perché impossibile trasmetterlo nel DTO
  	private String nuovoAllegatoBase64;				// Il file codificato in base64 dell'allegato caricato
	...
	public String getNomeNuovoAllegato() {
		return nomeNuovoAllegato;
	}

	public void setNomeNuovoAllegato(String nomeNuovoAllegato) {
		this.nomeNuovoAllegato = nomeNuovoAllegato;
	}

	public MultipartFile getNuovoAllegato() {
		return nuovoAllegato;
	}

	public void setNuovoAllegato(MultipartFile nuovoAllegato) {
		this.nuovoAllegato = nuovoAllegato;
	}

	public String getNuovoAllegatoBase64() {
		return nuovoAllegatoBase64;
	}

	public void setNuovoAllegatoBase64(String nuovoAllegatoBase64) {
		this.nuovoAllegatoBase64 = nuovoAllegatoBase64;
	}

	public String getNuovoAllegatoFileSize() {
		return nuovoAllegatoFileSize;
	}

	public void setNuovoAllegatoFileSize(String nuovoAllegatoFileSize) {
		this.nuovoAllegatoFileSize = nuovoAllegatoFileSize;
	}

	@Override
	public String toString() {
		return "GestioneAllegatiVO [idProgetto=" + idProgetto + ", idModello=" + idModello + ", numProtocollo="
				+ numProtocollo + ", idSoggDelegato=" + idSoggDelegato + ", idDocumentoIndex=" + idDocumentoIndex
				+ ", idSoggRapprLegale=" + idSoggRapprLegale + ", dtVerificaFirma=" + dtVerificaFirma
				+ ", idStatoDocumento=" + idStatoDocumento + ", versione=" + versione + ", dtAggiornamentoIndex="
				+ dtAggiornamentoIndex + ", idUtenteIns=" + idUtenteIns + ", idTipoDocumentoIndex="
				+ idTipoDocumentoIndex + ", messageDigest=" + messageDigest + ", idTarget=" + idTarget + ", repository="
				+ repository + ", flagFirmaCartacea=" + flagFirmaCartacea + ", nomeFile=" + nomeFile + ", uuidNodo="
				+ uuidNodo + ", noteDocumentoIndex=" + noteDocumentoIndex + ", dtMarcaTemporale=" + dtMarcaTemporale
				+ ", idUtenteAgg=" + idUtenteAgg + ", dtInserimentoIndex=" + dtInserimentoIndex + ", idEntita="
				+ idEntita + ", idCategAnagraficaMitt=" + idCategAnagraficaMitt + ", nomeDocumento=" + nomeDocumento
				+ ", nomeDocumentoFirmato=" + nomeDocumentoFirmato + ", nomeDocumentoMarcato=" + nomeDocumentoMarcato
				+ ", idDomanda=" + idDomanda + ", idSoggettoBenef=" + idSoggettoBenef + ", nomeNuovoAllegato="
				+ nomeNuovoAllegato + ", nuovoAllegatoFileSize=" + nuovoAllegatoFileSize + ", nuovoAllegato="
				+ nuovoAllegato + ", nuovoAllegatoBase64=" + nuovoAllegatoBase64 + "]";
	}
