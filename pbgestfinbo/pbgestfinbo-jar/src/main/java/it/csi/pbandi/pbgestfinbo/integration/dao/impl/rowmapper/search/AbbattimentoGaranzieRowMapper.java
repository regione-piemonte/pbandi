...
import it.csi.pbandi.pbgestfinbo.integration.vo.search.AbbattimentoGaranzieVO;
...
public class AbbattimentoGaranzieRowMapper implements RowMapper<AbbattimentoGaranzieVO> {
	...
	public AbbattimentoGaranzieVO mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		abbattimento.setIdAttivitaGaranzie(rs.getLong("ID_ABBATTIM_GARANZIE"));
		abbattimento.setIdProgetto(rs.getLong("ID_PROGETTO"));
		abbattimento.setDataAbbattimGaranzie(rs.getDate("DT_ABBATTIM_GARANZIE")); 
		abbattimento.setImpIniziale(rs.getLong("IMP_INIZIALE"));
		abbattimento.setImpLiberato(rs.getLong("IMP_LIBERATO"));
		abbattimento.setImpNuovo(rs.getLong("IMP_NUOVO"));
