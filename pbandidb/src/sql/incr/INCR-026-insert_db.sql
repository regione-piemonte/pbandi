...
Insert into PBANDI_D_TIPO_MODELLO
   (ID_TIPO_MODELLO, DESCR_TIPO_MODELLO)
 Values
   (1, 'Servizi documentale');
Insert into PBANDI_D_TIPO_MODELLO
   (ID_TIPO_MODELLO, DESCR_TIPO_MODELLO)
 Values
   (2, 'Servizi in loco');
Insert into PBANDI_D_TIPO_MODELLO
   (ID_TIPO_MODELLO, DESCR_TIPO_MODELLO)
 Values
   (3, 'Opere pubbliche documentale');
Insert into PBANDI_D_TIPO_MODELLO
   (ID_TIPO_MODELLO, DESCR_TIPO_MODELLO)
 Values
   (4, 'Opere pubbliche in loco');
COMMIT;
