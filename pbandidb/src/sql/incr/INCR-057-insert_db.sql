...
values
(56, 'BR56', 'Rendicontazione bando Residenzialità in montagna', to_date('24/05/2022','dd/mm/yyyy'));

update pbandi_c_regola
set DESC_REGOLA = 'Consente di inserire esclusivamente la dichiarazione di spesa finale'
where  DESC_BREVE_REGOLA = 'BR54';
