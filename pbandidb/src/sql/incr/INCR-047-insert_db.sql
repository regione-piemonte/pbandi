...
values (28,'RCC','REPORT CHIUSURA CONTI',NULL,NULL);
--
insert into PBANDI_C_OPERAZIONE 
values (924,'DESC_FIDICA','IndexDAO.creaContentReportChiusuraConti','S',TRUNC(SYSDATE), NULL);
--
update PBANDI_C_VERSIONE
set VERSIONE_DB = '3.18.0';
