...
ALTER TABLE PBANDI_T_ENTE_COMPETENZA ADD DESC_SETTORE varchar2(20);
-- VISTE
...
DECLARE
   ...
   Cursor c1 (c_id_documento_index NUMBER,
              c_id_sistema_prot NUMBER,
    ...
    SELECT id_documento_index
	  ...
	  AND   id_documento_index != c_id_documento_index;
...
*/
   ...
   OPEN c1 (:new.id_documento_index,
            :new.id_sistema_prot,
            :new.num_protocollo);
