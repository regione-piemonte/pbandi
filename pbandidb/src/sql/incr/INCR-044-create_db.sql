...
ALTER TABLE PBANDI_T_DOCUMENTO_DI_SPESA ADD FLAG_ELETT_XML VARCHAR2(1);
UPDATE PBANDI_T_DOCUMENTO_DI_SPESA SET FLAG_ELETT_XML = 'N';
COMMIT;
ALTER TABLE PBANDI_T_DOCUMENTO_DI_SPESA MODIFY FLAG_ELETT_XML NOT NULL;
ALTER TABLE PBANDI_T_DOCUMENTO_DI_SPESA ADD (
  CONSTRAINT CHK_FLAG_ELETT_XML
  CHECK (FLAG_ELETT_XML IN ('S', 'N'))); 
--
-- PBANDI_T_IRREGOLARITA
ALTER TABLE PBANDI_T_IRREGOLARITA MODIFY NOTE_PRATICA_USATA NULL;
--
