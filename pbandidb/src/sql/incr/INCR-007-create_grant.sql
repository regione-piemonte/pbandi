...
GRANT SELECT ON PBANDI.PBANDI_T_TRACCIAMENTO TO PBANDI_STORAGE;
GRANT SELECT ON PBANDI.PBANDI_T_TRACCIAMENTO_ENTITA TO PBANDI_STORAGE;
GRANT SELECT ON PBANDI.PBANDI_T_TRACCIAMENTO TO PBANDI_STORAGE_RW;
GRANT SELECT ON PBANDI.PBANDI_T_TRACCIAMENTO_ENTITA TO PBANDI_STORAGE_RW;
