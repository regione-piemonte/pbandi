...
Insert into PBANDI_D_ERRORE_BATCH
 ...
 Values
   ('E172', 'Gestione richiesta integrazione dichiarazione da GEFO');
COMMIT;

-- pbandi_d_task
Update pbandi_d_task SET DESCR_TASK = 'Registro controlli' WHERE DESCR_BREVE_TASK = 'RILEV-IRREGOLAR';
COMMIT;
