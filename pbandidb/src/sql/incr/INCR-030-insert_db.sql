...
Insert into PBANDI_D_ERRORE_BATCH
 ...
 Values
   ('W095', 'Cup non modificabile da flusso Finpis poichè già valorizzato ');
   
Insert into PBANDI.PBANDI_D_ERRORE_BATCH
   (CODICE_ERRORE, DESCRIZIONE)
 Values
   ('E165', 'Errore nella gestione del protocollo per il flusso GEFO');

Insert into PBANDI.PBANDI_D_ERRORE_BATCH
   (CODICE_ERRORE, DESCRIZIONE)
 Values
   ('W096', 'Identificativo documento digitale  non esistente su PBANDI');

Insert into PBANDI.PBANDI_D_ERRORE_BATCH
   (CODICE_ERRORE, DESCRIZIONE)
 Values
   ('W097', 'Progetto chiuso da processo interno. Non è possibile variare lo stato del progetto');
