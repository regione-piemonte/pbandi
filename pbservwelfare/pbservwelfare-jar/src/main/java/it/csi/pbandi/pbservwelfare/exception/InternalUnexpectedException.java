...
public class InternalUnexpectedException extends LocalException
{
  ...
  public InternalUnexpectedException(String message, LogParameter[] parameters, LogVariable[] variables)
  {
    super(message);
  ...
  public InternalUnexpectedException(Throwable cause, LogParameter[] parameters, LogVariable[] variables, String query,
