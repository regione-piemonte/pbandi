...
class GenericDatabaseObjectReader<T>
{
  ...
  protected void readField(T obj, int idx, ResultSetMetaData metaData, ResultSet rs) throws SQLException
  {
                      ...
                      else
                      {
                        ...
                        else
                        {
                          ...
                          else
                          {
                            ...
                            {
                              if (Blob.class == paramType || byte.class == paramType || byte[].class == paramType)
                              {
