...
import it.csi.pbandi.pbservwelfare.dto.profilazione.DecodificaDTO;
...
import it.csi.pbandi.pbservwelfare.util.DumpUtils;
...
public class BaseDAO
{
  ...
  public Date queryForDate(String query, SqlParameterSource parameters)
  {
    return namedParameterJdbcTemplate.query(query, parameters, new ResultSetExtractor<Date>()
    {
      @Override
  ...
  public int update(String query, MapSqlParameterSource parameters) throws InternalUnexpectedException
  {
	...
	public int update(String query, MapSqlParameterSource parameters,
			GeneratedKeyHolder generatedKeyHolder) throws InternalUnexpectedException
  {
    String THIS_METHOD = "update";
    if (logger.isDebugEnabled())
    {
    ...
    try
    {
			return namedParameterJdbcTemplate.update(query, parameters, generatedKeyHolder);
    }
    catch (Throwable t)
    {
      InternalUnexpectedException e = new InternalUnexpectedException(t, query, parameters);
  ...
  public int update(String query, MapSqlParameterSource parameters, GeneratedKeyHolder generatedKeyHolder, String[] keyColumnNames) throws InternalUnexpectedException
  {
    String THIS_METHOD = "update";
    if (logger.isDebugEnabled())
    {
    ...
    try
    {
      return namedParameterJdbcTemplate.update(query, parameters, generatedKeyHolder, keyColumnNames);
    }
    catch (Throwable t)
    {
      InternalUnexpectedException e = new InternalUnexpectedException(t, query, parameters);
  ...
  public long getNextSequenceValue(String sequenceName)
  {
	...
	param.addValue("sequence_name", sequenceName, Types.VARCHAR);
    
    //return namedParameterJdbcTemplate.queryForLong(query, (SqlParameterSource) null);
    return queryForLong(query, param);
  }
  ...
  public List<Long> queryForLongList(String query, MapSqlParameterSource mapParameterSource)
  {
    return namedParameterJdbcTemplate.query(query, mapParameterSource, new ResultSetExtractor<List<Long>>()
    {
  ...
  public List<Long> queryForLongListNull(String query, MapSqlParameterSource mapParameterSource)
  {
    return namedParameterJdbcTemplate.query(query, mapParameterSource, new ResultSetExtractor<List<Long>>()
    {
  ...
  public Boolean queryForBooleanNull(String query, MapSqlParameterSource mapParameterSource)
  {
    return namedParameterJdbcTemplate.query(query, mapParameterSource, new ResultSetExtractor<Boolean>()
    {
  ...
  public Integer queryForInteger(String query, MapSqlParameterSource mapParameterSource)
  {
    return namedParameterJdbcTemplate.query(query, mapParameterSource, new ResultSetExtractor<Integer>()
    {
