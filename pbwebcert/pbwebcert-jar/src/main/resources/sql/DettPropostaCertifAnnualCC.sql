select CODICE_PROGETTO as codiceProgetto , DESC_STATO_PROPOSTA_CERTIF as descStatoPropostaCertif , ID_LINEA_DI_INTERVENTO as idLineaDiIntervento , DIFF_CNA as diffCna , ID_PROPOSTA_CERTIFICAZ as idPropostaCertificaz , ID_UTENTE_AGG as idUtenteAgg , COLONNA_C as colonnaC , DIFF_SOPPR as diffSoppr , IMPORTO_CERTIF_NETTO_ANNUAL as importoCertifNettoAnnual , IMPORTO_PAGAM_VALID_CUM as importoPagamValidCum , DATA_AGG as dataAgg , DIFF_REC as diffRec , IMPORTO_REVOCHE_RILEV_CUM as importoRevocheRilevCum , DESC_BREVE_STATO_PROPOSTA_CERT as descBreveStatoPropostaCert , CERTIFICATO_LORDO_CUMULATO as certificatoLordoCumulato , IMPORTO_SOPPRESSIONI_CUM as importoSoppressioniCum , ID_STATO_PROPOSTA_CERTIF as idStatoPropostaCertif , NOME_BANDO_LINEA as nomeBandoLinea , ID_PROGETTO as idProgetto , ID_DETT_PROPOSTA_CERTIF as idDettPropostaCertif , IMPORTO_RECUPERI_CUM as importoRecuperiCum , ID_DETT_PROP_CERT_ANNUAL as idDettPropCertAnnual , IMPORTO_EROGAZIONI_CUM as importoErogazioniCum , BENEFICIARIO as beneficiario , DIFF_REV as diffRev , DESC_PROPOSTA as descProposta , CERTIFICATO_NETTO_CUMULATO as certificatoNettoCumulato , ASSE as asse from (
SELECT
    annual.*,
    dc.NOME_BANDO_LINEA,
    dc.CODICE_PROGETTO,
  ...
  FROM PBANDI_T_DETT_PROPOSTA_CERTIF dc,
    ...
    PBANDI_V_CERT_CHIUSURA_CONTI c
  ...
  AND c.ID_DETT_PROPOSTA_CERTIF = annual.ID_DETT_PROPOSTA_CERTIF
  AND c.ID_PROPOSTA_CERTIFICAZ = annual.ID_PROPOSTA_CERTIFICAZ
