...
import { CustomOptionalMatSelectDirective } from './custom-optional-mat-select-directive';
...
@NgModule({
    declarations: [
        CustomOptionalMatSelectDirective
    ],
    imports: dependences,
    exports: [...dependences, CustomOptionalMatSelectDirective],
    providers: [
