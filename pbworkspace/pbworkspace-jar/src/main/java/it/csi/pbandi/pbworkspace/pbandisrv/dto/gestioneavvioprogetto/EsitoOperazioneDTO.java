...
////{PROTECTED REGION ID(R-1021171991) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoOperazioneDTO.
 * Consigli:
 * <ul>
...
public class EsitoOperazioneDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1302587373) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-1871345506) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-894547537) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-276533310) ENABLED START*/
