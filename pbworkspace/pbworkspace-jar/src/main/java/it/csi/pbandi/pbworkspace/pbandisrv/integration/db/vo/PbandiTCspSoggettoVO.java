...
package it.csi.pbandi.pbworkspace.pbandisrv.integration.db.vo;

import java.math.*;
import java.sql.Date;
import java.util.List;

import it.csi.pbandi.pbservizit.pbandisrv.integration.db.util.DataFilter;
...
public class PbandiTCspSoggettoVO extends GenericVO {
	...
	public String toString() {
	    ...
	    temp = DataFilter.removeNull( pecSedeLegale);
	    if (!DataFilter.isEmpty(temp)) sb.append(" pecSedeLegale: " + temp + "\t\n");
