...
public class ContestoIdentificativoDTO {
	...
	public String toString() {
		...
		sb.append( "ContestoIdentificativoDTO [idUtente=" + idUtente + ", codFiscale=" + codFiscale + ", cognome=" + cognome);
		sb.append( ", nome=" + nome + ", descBreveTipoAnagrafica=" + descBreveTipoAnagrafica + ", idSoggetto=" + idSoggetto );
		sb.append( ", idIstanzaAttivitaProcesso=" + idIstanzaAttivitaProcesso + ", codUtenteFlux="	+ codUtenteFlux );
		sb.append( ", identitaIride=" + identitaIride + ", taskName=" + taskName + ", ruoloHelp=" + ruoloHelp + "]");
		return sb.toString();
	}
}
