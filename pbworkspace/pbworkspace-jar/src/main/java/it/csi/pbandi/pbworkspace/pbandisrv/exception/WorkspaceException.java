...
package it.csi.pbandi.pbworkspace.pbandisrv.exception;

import it.csi.csi.wrapper.SystemException;
import it.csi.csi.wrapper.UserException;
import it.csi.csi.wrapper.UnrecoverableException;

////{PROTECTED REGION ID(R-633425676) ENABLED START////}
/**
 * Inserire qui la documentazione dell'eccezione WorkspaceException.
 * Consigli:
 * <ul>
...
public class WorkspaceException extends UserException

{
	 ...
	 * @generated
	 */
	public WorkspaceException(String msg, String nestedExcClassName,
	 ...
	 * @generated
	 */
	public WorkspaceException(String msg, Throwable nested) {
		super(msg, nested);
	}
