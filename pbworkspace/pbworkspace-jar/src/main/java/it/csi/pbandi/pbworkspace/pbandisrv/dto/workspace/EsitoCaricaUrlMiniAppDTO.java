...
////{PROTECTED REGION ID(R432916405) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoCaricaUrlMiniAppDTO.
 * Consigli:
 * <ul>
...
public class EsitoCaricaUrlMiniAppDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R-849811807) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-774052454) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1788089010) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R-275815045) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R-1875896202) ENABLED START*/
