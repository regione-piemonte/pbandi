...
////{PROTECTED REGION ID(R-1247182774) ENABLED START////}
/**
 * Inserire qui la documentazione della classe EsitoAvvioProcessoDTO.
 * Consigli:
 * <ul>
...
public class EsitoAvvioProcessoDTO implements java.io.Serializable {
	...
	////{PROTECTED REGION ID(R1590488001) ENABLED START////}
	/**
	...
	////{PROTECTED REGION ID(R1600689298) ENABLED START////}
	/**
	...
	/*PROTECTED REGION ID(R2100689751) ENABLED START*/
